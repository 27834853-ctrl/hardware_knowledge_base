/**
 * 高速接口深度技术详�? * v2.6.3 - DisplayPort & HDMI 深度扩展完整�?(2,071�? + 其他接口内容优化
 *
 * 专注领域:
 * - 深度测试方法和标�? * - PCB设计精细要求
 * - 规范标准深度解读
    ...
    pcieTestingDeepDive: {
        ...
        content: `
            <div class="deep-dive-container">
                <h2><i class="fas fa-microscope"></i> PCIe深度测试与调试技�?/h2>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <h5>测试配置</h5>
                        <ul>
                            <li><strong>示波�?/strong>: 实时带宽 �?0 GHz (PCIe 3.0需16 GHz)</li>
                            <li><strong>探头</strong>: 差分探头，带宽≥示波器带�?/li>
                            <li><strong>测试�?/strong>: TX发送端参考点(TP1a/TP1b)</li>
                            <li><strong>负载</strong>: 标准测试负载板或compliance load</li>
                        </ul>

                        <h5>测试步骤</h5>
                        <ol>
                            <li>连接差分探头到TX输出�?DC耦合)</li>
                            <li>设置示波器触发在数据转换边沿</li>
                            <li>捕获至少10,000个UI的数�?/li>
                            <li>使用眼图mask测试功能</li>
                            <li>测量差分峰峰值电�? Vpp = |V(D+) - V(D-)|</li>
                            <li>测量共模电压: Vcm = (V(D+) + V(D-)) / 2</li>
                            <li>验证是否在规范范围内</li>
                        </ol>
                    </div>

                    <h4>1.2 预加�?De-emphasis)测试</h4>
                    <div class="concept-box">
                        <h5>预加重原�?/h5>
                        ...
                        <div class="formula-box">
                            ...
                            <p>其中:</p>
                            <ul>
                                <li>$V_{high}$: 首个UI的幅�?未加�?</li>
                                <li>$V_{low}$: 后续UI的幅�?已加�?</li>
                            </ul>
                        </div>
                        ...
                        <ol>
                            ...
                            <li>捕获包含"010"�?101"序列的波�?/li>
                            <li>测量第一个UI的峰值电�?V_high</li>
                            <li>测量后续UI的峰值电�?V_low</li>
                        ...
                        <div class="warning-box">
                            ...
                            <ul>
                                ...
                                <li><strong>测试点位�?/strong>: 必须在TX参考点测量，不能在connector�?/li>
                                <li><strong>触发稳定�?/strong>: 使用pattern lock功能确保触发准确</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="concept-box">
                        <h5>抖动分类与要�?/h5>
                        <p>PCIe将抖动分为确定性抖�?DJ)和随机抖�?RJ)，总抖�?TJ)需满足规范�?/p>

                        <div class="formula-box">
                            <p><strong>总抖动计�?/strong>:</p>
                            <p>$TJ = DJ + n \times RJ$</p>
                        ...
                        <h5>抖动测试流程</h5>
                        <ol>
                            <li><strong>设备连接</strong>: 使用BERT(误码�?或高性能示波�?/li>
                            <li><strong>数据捕获</strong>: 捕获�?0�?UI的数�?/li>
                    ...
                    <h4>1.4 TX均衡器系数测�?(Equalization Coefficients)</h4>
                    <div class="concept-box">
                        ...
                        <h5>系数测试方法</h5>
                        <ol>
                            <li><strong>读取系数</strong>: 通过LTSSM状态机读取协商的系�?/li>
                            <li><strong>波形捕获</strong>: 使用示波器捕获特定pattern
                                <ul>
                                    <li>测量"000...01000..."的幅�?�?提取 C₋₁</li>
                                    <li>测量"111...10111..."的幅�?�?提取 C₀</li>
                                    <li>测量"000...01000..."的幅�?�?提取 C₊₁</li>
                                </ul>
                            </li>
                            <li><strong>验证约束</strong>: 检查是否满足规范约束条�?/li>
                        </ol>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <h5>测试设备</h5>
                        <ul>
                            <li><strong>BERT(误码�?</strong>: 可编程信号发生器 + 误码检测器</li>
                            <li><strong>Compliance测试�?/strong>: 标准测试夹具</li>
                            <li><strong>抖动注入�?/strong>: 添加可控抖动</li>
                            <li><strong>衰减�?/strong>: 降低信号幅度</li>
                        </ul>

                        <h5>测试流程</h5>
                        <ol>
                            <li>配置BERT生成PCIe compliance pattern</li>
                            <li>设置信号幅度为测试点(�?75mV)</li>
                            <li>注入规范允许的最大抖�?�?.4 UI)</li>
                            <li>运行测试时间�?0�?�?0¹³ bits @ 8GT/s)</li>
                            <li>记录误码数，计算BER</li>
                            <li>要求: BER < 10⁻¹�?/li>
                        </ol>
                        ...
                        <div class="formula-box">
                            ...
                            <p>置信度计�?</p>
                            <p>对于BER = 10⁻¹�? 需要测�?> 10¹³ bits 才能有统计意�?/p>
                        </div>
                    </div>

                    <h4>2.2 RX均衡器测�?(CTLE & DFE)</h4>
                    <div class="concept-box">
                        <h5>RX均衡技�?/h5>
                        <ul>
                            <li><strong>CTLE (Continuous Time Linear Equalizer)</strong>: 连续时间线性均�?                                <ul>
                                    <li>模拟域均衡，补偿高频损�?/li>
                                    <li>提升高频增益，抑制低�?/li>
                                    <li>PCIe 3.0+必需</li>
                                </ul>
                        ...
                        <div class="example-box">
                            <h5>典型测试结果</h5>
                            <p><strong>未均�?/strong>:</p>
                            <ul>
                                <li>眼高: 80 mV</li>
                                <li>眼宽: 0.4 UI</li>
                                <li>BER: 10⁻⁶ (不合�?</li>
                            </ul>
                            <p><strong>均衡�?/strong>:</p>
                            <ul>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <div class="warning-box">
                            ...
                            <ul>
                                <li>TX电压不足或过�?/li>
                                <li>RX终端电阻不匹�?应为50Ω到Vcc/2)</li>
                                <li>PCB走线断路或短�?/li>
                                <li>AC耦合电容失效</li>
                            </ul>
                            <p><strong>调试方法</strong>:</p>
                            <ol>
                                <li>使用示波器测量TX差分电压(�?600mV)</li>
                                <li>检查RX端终端电�?万用表测�?</li>
                                <li>TDR测试检查阻抗连续�?/li>
                                <li>更换AC耦合电容</li>
                            </ol>
                        ...
                        <div class="warning-box">
                            ...
                            <p><strong>调试方法</strong>:</p>
                            <ol>
                                <li>测量RefClk抖动(�?120ps RMS)</li>
                                <li>捕获眼图，检查眼高眼�?/li>
                                <li>测量电源纹波(�?50mV pp)</li>
                        ...
                        <div class="warning-box">
                            ...
                            <p><strong>调试方法</strong>:</p>
                            <ol>
                                <li>VNA测量S21，检�?GHz处插�?/li>
                                <li>验证TX预加重比(�?3.5dB±1dB)</li>
                                <li>检查RX CTLE是否工作</li>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <div class="formula-box">
                            ...
                            <p><em>推荐更严�? ±100 mil</em></p>
                        </div>

                        <h5>走线间距</h5>
                        <ul>
                            <li><strong>对内间距</strong>: 保持恒定，通常为走线宽度的3�?/li>
                    ...
                    <div class="concept-box">
                        <h5>过孔引起的问�?/h5>
                        <ul>
                            <li><strong>阻抗不连�?/strong>: 过孔处阻抗降�?典型60-70Ω)</li>
                        ...
                        <div class="formula-box">
                            ...
                            <p><em>典型�? 1.6mm板厚, 0.3mm内径 �?L �?1.1 nH</em></p>
                        </div>
                    </div>
                    ...
                    <div class="concept-box">
                        ...
                        <ul>
                            <li><strong>优先</strong>: 在同一参考平面的层间换层
                                <ul>
                                    <li>�? L2↔L3 (GND在L1/L4)</li>
                                </ul>
                            </li>
                            <li><strong>避免</strong>: 更换参考平面类�?                                <ul>
                                    <li>�? GND参考→VCC参�?/li>
                                </ul>
                            </li>
                    ...
                    <div class="example-box">
                        ...
                        <ol>
                            <li><strong>协议分析</strong>:
                                <ul>
                                    <li>发现Phase 2中，Lane 0偶尔无法找到合适预�?/li>
                                    <li>其他lane正常</li>
                                </ul>
                            </li>
                        ...
                        <ul>
                            <li>�?永远不要让高速信号跨越参考平面分�?/li>
                            <li>�?逐lane测试，不要只看整体链�?/li>
                            <li>�?温度循环测试不可省略</li>
                        </ul>
                    </div>
...
<div class="section-block">
    <h3>9. PCIe LTSSM 状态机完整详解 (11个状�?</h3>

    <div class="intro-box">
        <h4>📖 LTSSM 简�?/h4>
        <p><strong>LTSSM (Link Training and Status State Machine)</strong> �?PCIe 链路初始化和管理的核心状态机，负责链路训练、速率协商、电源管理等关键功能。PCIe 规范定义�?11 个主状态和多个子状态�?/p>
    </div>

    <h4>9.1 LTSSM 11 个主状态概�?/h4>
    <div class="concept-box">
        <table class="reference-table">
            <thead>
                <tr>
    ...
    <div class="concept-box">
        ...
        <h5>状态转�?/h5>
        <ul>
            <li>�?<strong>检测到设备</strong> �?进入 <code>Polling</code> 状�?/li>
            <li>�?<strong>未检测到设备</strong> �?停留�?<code>Detect.Quiet</code> (周期性重�?</li>
        </ul>
    </div>

    <h4>9.3 Polling 状态详�?/h4>
    <div class="concept-box">
        <h5>状态目�?/h5>
        <p>建立 bit-level �?symbol-level 同步，确�?lane 极性，为后续配置做准备�?/p>
        ...
        <table class="reference-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>TS1 Ordered Set (持续发�?</td>
                    <td>等待接收 8 个连�?TS1/TS2</td>
                    <td>24 ms</td>
                </tr>
                <tr>
...
COM | Link# | Lane# | N_FTS | Data Rate | ... | Symbol 15
 (1) |  (2) |  (2)  |  (1)  |    (1)    | ... |   (1)
            ...
            <ul>
                ...
                <li><strong>Link#</strong>: 链路编号 (PAD 或实际编�?</li>
                <li><strong>Lane#</strong>: Lane 编号 (PAD 或实际编�?</li>
                <li><strong>N_FTS</strong>: Fast Training Sequence 数量</li>
                <li><strong>Data Rate</strong>: 支持的速率 (Gen 1/2/3/4/5/6)</li>
            </ul>
        </div>

        <h5>Bit Lock �?Symbol Lock</h5>
        <ul>
            <li><strong>Bit Lock</strong>: 时钟恢复电路 (CDR) 锁定到数据速率</li>
            <li><strong>Symbol Lock</strong>: 检测到 8B/10B �?comma 字符 (K28.5)，确�?10-bit symbol 边界</li>
            <li><strong>Lane Polarity Detection</strong>: 如果 D+/D- 接反，自动翻转极�?/li>
        </ul>

        <h5>状态转�?/h5>
        <ul>
            <li>�?<strong>接收�?8 �?TS2</strong> �?进入 <code>Configuration</code> 状�?/li>
            <li>⏱️ <strong>超时 (24 ms)</strong> �?返回 <code>Detect</code></li>
        </ul>
    </div>

    <h4>9.4 Configuration 状态详�?/h4>
    <div class="concept-box">
        <h5>状态目�?/h5>
        <p>协商链路宽度 (x1/x2/x4/x8/x16)，分�?Link �?Lane 编号，准备进�?L0 工作态�?/p>
        ...
        <table class="reference-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>开�?Link width 协商</td>
                    <td>发�?TS1 (�?Link/Lane 编号)</td>
                </tr>
                <tr>
                    <td><strong>Configuration.Linkwidth.Accept</strong></td>
                    <td>接受协商�?Link width</td>
                    <td>接收 8 �?TS1 (Link/Lane 匹配)</td>
                </tr>
                <tr>
        ...
        <div class="example-box">
            ...
            <ol>
                <li><strong>Device (Downstream Port)</strong>: 发�?TS1, 声明支持 x16</li>
                <li><strong>Root Complex (Upstream Port)</strong>: 发�?TS1, 声明只能提供 x8</li>
                <li><strong>协商结果</strong>: 取较小值，链路建立�?<strong>x8</strong></li>
                <li><strong>Lane 0-7</strong>: 用于数据传输</li>
                <li><strong>Lane 8-15</strong>: 未连接或未使�?/li>
            </ol>
        ...
        <h5>状态转�?/h5>
        <ul>
            <li>�?<strong>配置成功</strong> �?进入 <code>L0</code> 状�?(正常工作)</li>
            <li>�?<strong>协商失败或超�?/strong> �?返回 <code>Detect</code> �?<code>Recovery</code></li>
        </ul>
    </div>
    ...
    <div class="concept-box">
        <h5>状态特�?/h5>
        <ul>
            <li>�?<strong>全速数据传�?/strong>: TLP (Transaction Layer Packet) �?DLLP 传输</li>
            <li>�?<strong>链路活跃</strong>: TX/RX 均处于活动状�?/li>
            <li>�?<strong>功耗最�?/strong>: 所有电路全开</li>
        </ul>
        ...
        <table class="reference-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>时钟容差补偿</td>
                    <td>�?1180-1538 Symbols 插入一�?(Gen 1/2)</td>
                </tr>
                <tr>
                    <td><strong>FTS (Fast Training Sequence)</strong></td>
                    <td>�?L0s 快速恢�?/td>
                    <td>发�?N_FTS �?(通常 128-255 �?</td>
                </tr>
                <tr>
    ...
    <h4>9.6 L0s 状�?(快速低功耗�?</h4>
    <div class="concept-box">
        <h5>状态特�?/h5>
        <ul>
            <li>�?<strong>快速进�?/strong>: &lt; 1 μs</li>
            <li>�?<strong>快速退�?/strong>: &lt; 1 μs (通过 FTS 序列)</li>
            <li>💾 <strong>功耗节�?/strong>: 中等 (~30-50%)</li>
            <li>🔀 <strong>独立控制</strong>: TX �?RX 可独立进�?L0s</li>
        </ul>
        ...
        <ol>
            ...
            <li>接收端检测到 Electrical Idle，进�?L0s</li>
        </ol>
        ...
        <div class="example-box">
            <h5>�?L0s 恢复�?L0</h5>
            <ol>
                <li><strong>发送端</strong>: 发�?N_FTS �?FTS Ordered Sets (根据 Configuration 时协商的�?</li>
                <li><strong>接收�?/strong>: CDR 重新锁定到数据速率</li>
                <li><strong>恢复完成</strong>: 开始传�?IDLE �?TLP</li>
            </ol>
            <p><strong>典型恢复时间</strong>: 200-500 ns (取决�?N_FTS �?</p>
        </div>

        <h5>L0s 适用场景</h5>
        <ul>
            <li>�?<strong>突发流量</strong>: 网络数据包传输间�?/li>
            <li>�?<strong>低延迟要�?/strong>: 需要快速唤醒的应用 (NVMe SSD)</li>
            <li>�?<strong>持续流量</strong>: 视频流、大文件传输（不适合进入 L0s�?/li>
        </ul>
    </div>

    <h4>9.7 L1 状�?(低功耗待机�?</h4>
    <div class="concept-box">
        <h5>状态特�?/h5>
        <ul>
            <li>⏱️ <strong>进入时间</strong>: 数十 μs</li>
            <li>⏱️ <strong>退出时�?/strong>: 2-4 μs</li>
            <li>💾 <strong>功耗节�?/strong>: 显著 (~80-90%)</li>
            <li>🔗 <strong>双向协商</strong>: 需要双方同意才能进�?/li>
        </ul>

        <h5>L1 进入流程</h5>
        <div class="example-box">
            <ol>
                <li><strong>Downstream Port</strong>: 发�?PM_Enter_L1 DLLP</li>
                <li><strong>Upstream Port</strong>: 回应 PM_Enter_L1 DLLP (同意)</li>
                <li><strong>双方</strong>: 停止传输 TLP，发�?EIOS (Electrical Idle Ordered Set)</li>
                <li><strong>进入 L1</strong>: 链路进入 Electrical Idle，关闭大部分电路</li>
            </ol>
        </div>

        <h5>L1 子状�?(PCIe 4.0+)</h5>
        <table class="reference-table">
            <thead>
                <tr>
                    <th>子状�?/th>
        ...
        <h5>L1 退出流�?/h5>
        <ol>
            <li><strong>任一�?/strong>: 退�?Electrical Idle，开始发�?FTS Ordered Sets</li>
            <li><strong>接收�?/strong>: 检测到 FTS，重新锁�?CDR</li>
            <li><strong>链路训练</strong>: 发�?TS1/TS2 快速重训练 (简化流�?</li>
            <li><strong>返回 L0</strong>: 开始正常数据传�?/li>
        </ol>
    </div>

    <h4>9.8 L2 状�?(深度低功耗�?</h4>
    <div class="concept-box">
        <h5>状态特�?/h5>
        <ul>
            <li>💤 <strong>最低功�?/strong>: 主电源可关闭，仅保留辅助电源 (Vaux)</li>
            <li>⏱️ <strong>长唤醒时�?/strong>: 20-100 ms (需完整 LTSSM 重训�?</li>
            <li>🔌 <strong>系统级节�?/strong>: 配合 ACPI S3/S4 睡眠状�?/li>
        </ul>

        <h5>L2 进入条件</h5>
        <ul>
            <li><strong>软件触发</strong>: OS 设置 PCIe 设备进入 D3hot/D3cold 电源状�?/li>
            <li><strong>硬件响应</strong>: 发�?PM_Enter_L23 DLLP</li>
            <li><strong>确认</strong>: 收到 PM_Request_Ack DLLP</li>
            <li><strong>关闭主电�?/strong>: 进入 L2 (L3 Ready)</li>
        </ul>
        ...
        <div class="example-box">
            <ol>
                ...
                <li><strong>发�?Beacon</strong>: �?RX Lane 上发送低�?Beacon 信号 (~100 MHz)</li>
                <li><strong>Root Complex</strong>: 检测到 Beacon，恢�?Vcc 主电�?/li>
                <li><strong>完整 LTSSM</strong>: �?Detect �?Polling �?Configuration �?L0</li>
                <li><strong>恢复完成</strong>: 重新枚举设备，恢复软件状�?/li>
            </ol>
            <p><strong>总唤醒时�?/strong>: 通常 50-200 ms</p>
        </div>
    </div>

    <h4>9.9 Recovery 状态详�?/h4>
    <div class="concept-box">
        <h5>状态目�?/h5>
        <p>�?L0/L0s/L1 恢复链路，执行速率切换 (Gen 切换) 或均衡调�?(Equalization)，无需完整重新训练�?/p>
        ...
        <h5>Recovery 触发条件</h5>
        <ul>
            <li>🔄 <strong>�?L1 退�?/strong></li>
            <li>🔄 <strong>速率切换</strong>: Gen 1 �?Gen 2 �?Gen 3 ...</li>
            <li>🔄 <strong>Equalization 请求</strong>: 改善信号质量</li>
            <li>⚠️ <strong>错误恢复</strong>: 检测到 8B/10B �?CRC 错误超过阈�?/li>
        </ul>

        <h5>速率切换示例 (Gen 1 �?Gen 3)</h5>
        <div class="example-box">
            <ol>
                <li><strong>初始链路</strong>: �?Gen 1 (2.5 GT/s) 下工�?/li>
                <li><strong>软件请求</strong>: 设置 Link Control 2 寄存器为 Gen 3</li>
                <li><strong>进入 Recovery</strong>: 发�?TS1 (声明目标速率 Gen 3)</li>
                <li><strong>双方协商</strong>: 交换 TS1/TS2，确认支�?Gen 3</li>
                <li><strong>切换速率</strong>: �?2.5 GT/s �?5.0 GT/s �?8.0 GT/s</li>
                <li><strong>Equalization (Gen 3)</strong>: 执行 Phase 2/3 均衡</li>
                <li><strong>返回 L0</strong>: �?Gen 3 速率下工�?/li>
            </ol>
            <p><strong>总耗时</strong>: ~2-5 ms</p>
        </div>
    </div>

    <h4>9.10 Hot Reset 状�?/h4>
    <div class="concept-box">
        <h5>状态特�?/h5>
        <ul>
            <li>🔥 <strong>链路级复�?/strong>: 不影响物理电�?/li>
            <li>⏱️ <strong>复位时间</strong>: 2 ms (TS1 持续发�?</li>
            <li>🔄 <strong>重新初始�?/strong>: 复位后返�?Detect 重新训练</li>
        </ul>

        <h5>触发方式</h5>
        <ol>
            <li><strong>软件触发</strong>: �?Bridge Control 寄存器的 Secondary Bus Reset �?/li>
            <li><strong>硬件响应</strong>: Downstream Port 在所�?Lane 上发�?TS1 (Hot Reset = 1) 持续 2 ms</li>
            <li><strong>Upstream 设备</strong>: 检测到 Hot Reset，复位内部状�?/li>
            <li><strong>完成�?/strong>: 返回 Detect �?Polling �?Configuration �?L0</li>
        </ol>
    ...
    <h4>9.11 Disabled �?Loopback 状�?/h4>
    <div class="concept-box">
        <h5>Disabled 状�?/h5>
        <ul>
            <li><strong>进入方式</strong>: 软件设置 Link Control 寄存�?Link Disable �?/li>
            <li><strong>状态表�?/strong>: TX/RX 进入 Electrical Idle，链路完全禁�?/li>
            <li><strong>退出方�?/strong>: 清除 Link Disable 位，返回 Detect 重新训练</li>
            <li><strong>应用场景</strong>: 热插拔准备、故障隔�?/li>
        </ul>

        <h5>Loopback 状�?(Compliance 测试)</h5>
        <ul>
            <li><strong>Loopback Master</strong>: 生成测试 pattern (�?LFSR-23)</li>
            <li><strong>Loopback Slave</strong>: 将接收到的数据原样返�?/li>
...
┌─────────────────────────────────────────────────────────────────�?�?                       PCIe LTSSM 状态机                         �?└─────────────────────────────────────────────────────────────────�?
  [系统上电]
   ...
   └──────────�?       �?配置完成
       �?   ┌──────────�? ←───────────────────────────�?   �?   L0    �? �?Recovery (速率切换/EQ)     �?   �?(正常工作)�?                             �?   └──────────�?                              �?       �?  �?  �?                             �?       �?  �?  └──�?[L0s] (快速低功�? ──────�?       �?  �?       �?  └──────�?[L1] (低功�? ────�?Recovery �?L0
       �?       └──────────�?[L2/L3] (深度低功�? �?[Beacon唤醒] �?Detect

   特殊状�?
   �?Hot Reset: 从任意状态进入，持续2ms后返�?Detect
   �?Disabled: 软件命令禁用链路
   �?Loopback: Compliance 测试模式
        </pre>
    </div>

    <h4>9.13 LTSSM 调试技�?/h4>
    <div class="warning-box">
        <h5>⚠️ 常见 LTSSM 问题与排�?/h5>
        <table class="reference-table">
            <thead>
                <tr>
                    <th>现象</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>检�?PERST# 时序、参考时钟、RX检测电�?/td>
                </tr>
                <tr>
                    <td>链路宽度降级 (x16→x8)</td>
                    <td>Configuration</td>
                    <td>检�?Lane 信号质量、PCB走线</td>
                </tr>
                <tr>
                    <td>无法切换�?Gen 3</td>
                    <td>Recovery.Speed</td>
                    <td>检�?TX 预加重、RX 均衡设置</td>
                </tr>
                <tr>
                    <td>频繁进入 Recovery</td>
        ...
        <h5>📊 LTSSM 监控工具</h5>
        <ul>
            <li><strong>lspci -vvv</strong>: 查看当前链路状�?(LnkSta 寄存�?</li>
            <li><strong>Logic Analyzer</strong>: 抓取 LTSSM 状态转换时�?/li>
            <li><strong>PCIe Protocol Analyzer</strong>: 解析 TS1/TS2 Ordered Sets</li>
            <li><strong>Scope</strong>: 监控 Electrical Idle 进入/退出波�?/li>
        </ul>
    </div>
</div>

<div class="section-block">
    <h3>10. PCIe Gen 6 (64 GT/s) PAM4 技术深度解�?/h3>

    <div class="intro-box">
        <h4>🚀 PCIe 6.0 革命性变�?/h4>
        <p><strong>PCIe 6.0</strong> 是自 PCIe 1.0 以来最大的架构变革，引�?<strong>PAM4 (4-Level Pulse Amplitude Modulation)</strong> 信号调制取代传统 NRZ，在相同时钟频率下实�?<strong>2倍带宽提�?/strong>，达�?<strong>64 GT/s</strong>�?/p>
    </div>
    ...
    <div class="concept-box">
        ...
        <ul>
            <li><strong>信号电平</strong>: 2 �?(�?低，表示 0/1)</li>
            <li><strong>每个符号传输</strong>: 1 bit 信息</li>
            <li><strong>简单可�?/strong>: 接收端判决容易，抗噪声能力强</li>
            <li><strong>带宽限制</strong>: 32 GT/s (PCIe 5.0) 已接近物理极�?/li>
        </ul>

        <h5>PAM4 (4-Level PAM) - PCIe 6.0</h5>
        <ul>
            <li><strong>信号电平</strong>: 4 �?(00, 01, 10, 11)</li>
            <li><strong>每个符号传输</strong>: 2 bits 信息</li>
            <li><strong>带宽翻�?/strong>: 32 GBaud × 2 bits/symbol = <strong>64 GT/s</strong></li>
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            ...
            <p><strong>眼高损失</strong>: PAM4 眼高仅为 NRZ �?<strong>33.3%</strong> (损失 9.5 dB)</p>
        </div>

        <h5>Gray Coding (格雷�?</h5>
        ...
        <p><strong>优势</strong>: Level 0�?, 1�?, 2�? 的误判只导致 1-bit 错误（而非 2-bit�?/p>
    </div>

    <h4>10.3 PCIe 6.0 FLIT �?FEC</h4>
    <div class="concept-box">
        <h5>FLIT (Flow Control Unit) 模式</h5>
        <p>PCIe 6.0 引入 <strong>FLIT 模式</strong> 取代传统的可变长�?TLP，每�?FLIT 固定 <strong>256 Bytes</strong>�?/p>
        <ul>
            <li><strong>固定长度</strong>: 256 Bytes FLIT = 2048 bits</li>
            <li><strong>FEC 开销</strong>: �?242 bits 数据添加 14 bits FEC 校验</li>
            <li><strong>CRC 移除</strong>: 不再需要独立的 CRC32 校验（FEC 已覆盖）</li>
            <li><strong>流控简�?/strong>: 固定长度简化流控和缓冲管理</li>
        </ul>

        <h5>FEC (Forward Error Correction) - CRC 循环冗余校验</h5>
        <p>PCIe 6.0 采用 <strong>RS (Reed-Solomon) 类似�?FEC 编码</strong>�?/p>
        <div class="formula-box">
            <p><strong>编码比例</strong>:</p>
            <p>$\frac{Data}{Total} = \frac{242\ bits}{256\ bits} = 94.5\%$</p>
            <p><strong>开销</strong>: 5.5% (vs NRZ 128b/130b �?1.54%)</p>
        </div>

        <h5>FEC 纠错能力</h5>
        <ul>
            <li>�?<strong>单比特纠�?/strong>: 自动纠正 1-bit 错误</li>
            <li>�?<strong>多比特检�?/strong>: 检�?2-3 bits 错误（无法纠正，触发重传�?/li>
            <li>📊 <strong>BER 改善</strong>: �?10^-12 提升�?10^-17 (5 个数量级)</li>
        </ul>
...
结果:     无需重传，零延迟纠错 �?            </pre>
    ...
    <div class="concept-box">
        <h5>PAM4 眼图特征</h5>
        <p>PAM4 �?<strong>3 个眼�?/strong> (Eye 0/1/2)，分别对�?3 个电平过渡区域：</p>
        ...
        <table class="reference-table">
            ...
            <tbody>
                <tr>
                    <td><strong>Eye Height (每个�?</strong></td>
                    <td>&gt; 25 mV (TP2)</td>
                    <td>测试�?TP2 (接收端前)</td>
                </tr>
                <tr>
        ...
        <ul>
            ...
            <li><strong>采样�?/strong>: �?256 GSa/s</li>
            <li><strong>PAM4 解码</strong>: 必须支持 PAM4 信号分析</li>
            <li><strong>FEC 解码</strong>: 最好支�?PCIe 6.0 FEC 后处�?/li>
        </ul>
    </div>

    <h4>10.5 PAM4 均衡技�?(CTLE + DFE)</h4>
    <div class="concept-box">
        <h5>为何 PAM4 需要更强均衡？</h5>
        <ul>
            <li>📉 <strong>眼高缩减</strong>: PAM4 眼高�?NRZ �?1/3，对 ISI 敏感</li>
            <li>📉 <strong>高频损�?/strong>: 32 GBaud 接近 PCB 材料极限 (~30 GHz)</li>
            <li>📉 <strong>信噪比要�?/strong>: 28 dB SNR 要求精确�?ISI 消除</li>
        </ul>

        <h5>CTLE (Continuous-Time Linear Equalization)</h5>
        <p><strong>模拟前端均衡�?/strong>，在 ADC 之前补偿高频损耗：</p>
        <div class="formula-box">
            <p><strong>CTLE 传递函�?/strong>:</p>
            <p>$H_{CTLE}(f) = A_{DC} \times \left(1 + \frac{f}{f_z}\right) / \left(1 + \frac{f}{f_p}\right)$</p>
            <p>其中:</p>
            <ul>
                <li>$f_z$: 零点频率 (Boost 起点，典�?5 GHz)</li>
                <li>$f_p$: 极点频率 (Boost 终点，典�?20 GHz)</li>
                <li>$A_{DC}$: 直流增益</li>
            </ul>
        ...
        <p><strong>数字反馈均衡�?/strong>，消除后�?ISI（前一个符号对当前符号的影响）�?/p>
        <ul>
            <li><strong>工作原理</strong>:
                <ol>
                    <li>判决当前符号值（Level 0/1/2/3�?/li>
                    <li>根据历史判决结果，预测当�?ISI 影响</li>
                    <li>从当前接收信号中减去预测�?ISI</li>
                    <li>重新判决，得到纠正后的符�?/li>
                </ol>
            </li>
            <li><strong>抽头�?/strong>: PCIe 6.0 通常 8-16 个抽�?/li>
            <li><strong>自适应算法</strong>: LMS (Least Mean Square) �?Sign-Sign LMS</li>
        </ul>
    ...
    <div class="warning-box">
        <h5>⚠️ PCIe 6.0 设计挑战与解决方�?/h5>

        <h5>1. PCB 材料选择</h5>
        <ul>
            <li><strong>推荐材料</strong>: Megtron 6/7, Panasonic M7, Rogers RO4350B</li>
            <li><strong>损耗要�?/strong>: Df (Loss Tangent) &lt; 0.005 @ 10 GHz</li>
        ...
        <h5>4. 测试验证流程</h5>
        <ol>
            <li><strong>S参数测试</strong>: 使用 VNA 测量插入损�?(IL) &lt; -30 dB @ 32 GHz</li>
            <li><strong>Eye 高度测试</strong>: 确认 3 个眼睛均 &gt; 25 mV</li>
            <li><strong>Jitter 测试</strong>: Tj &lt; 0.25 UI @ BER 10^-12</li>
            <li><strong>FEC �?BER</strong>: 确认 &lt; 10^-17</li>
            <li><strong>长时间稳定�?/strong>: 48 小时 BER 监控</li>
        </ol>
    </div>
    ...
    <div class="concept-box">
        ...
        <h5>应用场景</h5>
        <ul>
            <li><strong>AI/ML 加速卡</strong>: GPU �?CPU 高速互�?(NVIDIA H100, AMD MI300)</li>
            <li><strong>高性能 SSD</strong>: Gen 6 x4 = 31.5 GB/s (vs Gen 4 x4 = 7.88 GB/s)</li>
            <li><strong>网络适配�?/strong>: 400GbE / 800GbE 网卡</li>
...
<div class="summary-box">
    ...
    <ul>
        <li>�?<strong>LTSSM 11 状态详�?/strong>: �?Detect �?L2，涵盖链路训练、功耗管理、速率切换全流�?/li>
        <li>�?<strong>PCIe 6.0 PAM4 技�?/strong>: 信号调制原理、FEC 纠错、眼图测试、均衡设�?/li>
        <li>�?<strong>实战设计要点</strong>: PCB 材料选择、Via 优化、均衡系数调�?/li>
        <li>�?<strong>性能对比</strong>: Gen 5 vs Gen 6 带宽翻�?(63�?26 GB/s @ x16)</li>
    </ul>
    <p><strong>新增内容�?/strong>: ~500 行专业技术详�?/p>
</div>
    ...
    usbTestingDeepDive: {
        ...
        content: `
            <div class="deep-dive-container">
                <h2><i class="fab fa-usb"></i> USB深度测试与规范解�?/h2>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <div class="warning-box">
                            ...
                            <ul>
                                <li><strong>电压范围</strong>: 最�?8V (240W)</li>
...
<div class="section-block">
    ...
    <h4>7.1 USB4 架构�?Tunneling 原理</h4>
    <div class="concept-box">
        <h5>USB4 Router 架构</h5>
        <p>USB4 引入 <strong>Router</strong> 概念，每�?Router 包含多个 <strong>Adapter</strong> 用于不同协议转换�?/p>
        <ul>
            ...
            <li><strong>DisplayPort IN/OUT Adapter</strong>: 处理 DP 视频�?/li>
        ...
        <div class="example-box">
            <pre>
应用�? USB 3.2 数据 | DisplayPort 视频 | PCIe NVMe 命令
         �?              �?                 �?Adapter: USB3 Adapter | DP IN Adapter   | PCIe Adapter
         �?              �?                 �?Tunneling: 封装�?USB4 Packet (Header + Payload)
         �?物理�? USB4 Link (2-lane or 4-lane, 40 Gbps max)
         �?接收�? 解封�?�?路由到对�?Adapter �?恢复原始协议
            </pre>
        </div>
    ...
    <div class="warning-box">
        ...
        <ul>
            ...
            <li><strong>带宽分配公平�?/strong>: 多协议并发时无饥饿现�?/li>
            <li><strong>PCIe Tunneling BER</strong>: &lt; 10^-12 (TLP 重传�?&lt; 0.01%)</li>
            <li><strong>DP 视频完整�?/strong>: 4K@60Hz 无花屏、无丢帧</li>
        </ul>
    </div>
</div>
...
<div class="section-block">
    ...
    <div class="intro-box">
        <h4>�?PD 3.1 EPR 革命性升�?/h4>
        <p><strong>USB PD 3.1</strong> 引入 <strong>EPR (Extended Power Range)</strong>，将最大功率从 100W 提升�?<strong>240W</strong>，支持高性能笔记本、游戏本和工作站的快充需求�?/p>
    </div>
    ...
    <div class="concept-box">
        <div class="example-box">
            ...
            <ol>
                ...
                <li><strong>线缆检�?/strong>: 读取 E-Marker IC，确认支�?EPR (240W capable)</li>
                <li><strong>发�?Source_Capabilities</strong>:
                    <pre>
PDO 1: 5V @ 3A (15W)
PDO 2: 9V @ 3A (27W)
PDO 3: 15V @ 3A (45W)
...
PDO 7: 48V @ 5A (240W) - EPR AVS 48V �?                    </pre>
                </li>
                <li><strong>Sink 请求</strong>: 发�?Request 消息，选择 PDO 7 (48V@5A)</li>
                <li><strong>Source 确认</strong>: 发�?Accept 消息</li>
                <li><strong>电压切换</strong>: Source 输出�?5V 平滑过渡�?48V (斜率控制)</li>
                <li><strong>PS_RDY</strong>: 电压稳定后发�?Power Supply Ready</li>
                <li><strong>充电开�?/strong>: Sink 开始以 240W 功率充电 �?/li>
            </ol>
            <p><strong>总握手时�?/strong>: ~200-500 ms</p>
        </div>
    </div>
    ...
    <div class="warning-box">
        ...
        <ul>
            <li><strong>过压保护 (OVP)</strong>: 电压超过设定�?+10% 时断开</li>
            <li><strong>过流保护 (OCP)</strong>: 电流超过 5.5A 时限流或断开</li>
            <li><strong>过温保护 (OTP)</strong>: 充电�?线缆温度 &gt; 85°C 时降功率</li>
            <li><strong>线缆认证</strong>: 必须检�?E-Marker EPR 标识，否则限制在 100W</li>
            <li><strong>通信看门�?/strong>: PD 消息中断 &gt; 5s，自动回退�?5V</li>
        </ul>
        ...
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>动态响�?/strong></td>
                    <td>负载 0�?40W 时电压跌�?&lt; 5%</td>
                    <td>电子负载突变测试</td>
                </tr>
                <tr>
    ...
    <h4>8.4 EPR 充电器设计要�?/h4>
    <div class="concept-box">
        <h5>240W EPR 充电器关键设�?/h5>
        <ul>
            <li><strong>拓扑选择</strong>: LLC 谐振 + 同步整流 (效率 &gt; 94%)</li>
            <li><strong>PD 控制�?/strong>: Cypress CCG7 / TI TPS65987 (支持 EPR)</li>
            <li><strong>线缆要求</strong>: 5A E-Marker 线，24AWG 电源线，支持 EPR 标记</li>
            <li><strong>散热设计</strong>: 主动风扇散热�?40W 满载�?~14W 损耗）</li>
            <li><strong>GaN 器件</strong>: 650V GaN HEMT (�?EPC2045) 实现小体积高效率</li>
        </ul>

        <div class="formula-box">
            <p><strong>充电器效率计�?/strong>:</p>
            <p>$Efficiency = \\frac{P_{out}}{P_{in}} = \\frac{240W}{240W + P_{loss}}$</p>
            <p>假设效率 94%:</p>
            <p>$P_{loss} = \\frac{240W}{0.94} - 240W = 15.3W$</p>
            <p><strong>温升估算</strong>: 15.3W 损�?�?外壳温升 ~40°C (需散热�?</p>
        </div>
    </div>
</div>
...
<div class="summary-box">
    ...
    <ul>
        ...
        <li>�?<strong>USB PD 3.1 EPR</strong>: 240W 快充�?8V/36V/48V 档位</li>
    ...
    mipiTestingDeepDive: {
        ...
        content: `
            <div class="deep-dive-container">
                <h2><i class="fas fa-camera"></i> MIPI深度测试与调�?/h2>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <ul>
                            ...
                            <li>数据速率: 最�?.5 Gbps/lane (D-PHY v2.1)</li>
                            <li>测试�? TX发送端参考点</li>
                            <li>最小眼�? 85 mV</li>
                            <li>最小眼�? 0.35 UI</li>
                        </ul>
                    ...
                    <div class="concept-box">
                        ...
                        <ul>
                            ...
                            <li><strong>HS-Prepare</strong>: HS准备时间
                                <ul>
                                    <li>LP-00持续时间: 40ns + 4×UI�?85ns + 6×UI</li>
                                </ul>
                            </li>
                            <li><strong>HS-Zero</strong>: HS零时�?                                <ul>
                                    <li>145ns + 10×UI</li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <div class="warning-box">
                            ...
                            <ul>
                                <li><strong>电压电平不足</strong>: Vil/Vih超出范围
                                    <ul>
                                        <li>检查上�?下拉电阻�?通常1-10kΩ)</li>
                                        <li>验证VDD_LP电源(1.2V)</li>
                                    </ul>
                                </li>
                                <li><strong>转换时序不对</strong>: 无法识别状�?                                    <ul>
                                        <li>测量实际TLP-X时间</li>
                                        <li>调整PHY配置寄存�?/li>
                                    </ul>
                                </li>
                    ...
                    <div class="concept-box">
                        ...
                        <div class="example-box">
                            ...
                            <ol>
                                ...
                                <li>检查I2C通信:
                                    <ul>
                                        <li>I2C地址正确(7-bit�?0-bit)</li>
                                        <li>上拉电阻(2.2kΩ-10kΩ)</li>
                                        <li>时钟速率(通常100kHz�?00kHz)</li>
                                    </ul>
                                </li>
                                <li>复位信号:
                                    <ul>
                                        <li>复位后等待时�?通常>20ms)</li>
                                        <li>复位极性正�?/li>
                                    </ul>
                                </li>
                            </ol>
                ...
                <div class="section-block">
                    ...
                    <div class="concept-box">
                        ...
                        <h5>C-PHY符号编码</h5>
                        <p>C-PHY使用3条线(A, B, C)传输7种符号状�?</p>
                        <ul>
                            <li><strong>+x</strong>: A�?1, B�?1, C�?</li>
                            <li><strong>-x</strong>: A�?1, B�?1, C�?</li>
                            <li><strong>+y</strong>: B�?1, C�?1, A�?</li>
                            <li><strong>-y</strong>: B�?1, C�?1, A�?</li>
                            <li><strong>+z</strong>: C�?1, A�?1, B�?</li>
                            <li><strong>-z</strong>: C�?1, A�?1, B�?</li>
                            <li><strong>000</strong>: 零状�?(未使�?</li>
                        </ul>

                        <div class="formula-box">
                            <p><strong>数据率计�?/strong>:</p>
...
<div class="section-block">
    ...
    <div class="intro-box">
        ...
        <p><strong>MIPI C-PHY</strong> 采用创新�?<strong>三相编码 (3-Phase Encoding)</strong>，通过 3 根信号线传输，相比传�?D-PHY 差分对，可实现更高的数据速率和更好的 EMI 性能，最高支�?<strong>5.71 Gbps/Trio</strong>（相当于 D-PHY �?2.5 Gbps/Lane）�?/p>
    </div>

    <h4>6.1 C-PHY 三相信号原理</h4>
    <div class="concept-box">
        <h5>三相编码基本概念</h5>
        <p>C-PHY 使用 3 根信号线 (A, B, C) 形成一�?<strong>Trio</strong>，每根线可处�?3 种电压状�?(+1, 0, -1)，通过状态组合传输数据�?/p>
        ...
        <p><strong>关键约束</strong>: A + B + C = 0 (电荷守恒)，因此只�?5 种有效状态，外加 1 种保留状�?(-z)，共 6 种状态可编码�?/p>

        <div class="formula-box">
            <p><strong>编码效率</strong>:</p>
            <p>$\log_2(6) �?2.585\ bits/symbol$</p>
            <p>相比 D-PHY (1 bit/symbol)，编码效率提�?<strong>2.58 �?/strong></p>
        </div>
    </div>
    ...
    <div class="concept-box">
        <h5>编码映射</h5>
        <p>C-PHY 使用 <strong>16-to-7 编码</strong>：每 16 bits 数据映射�?7 个三相符�?(symbols)�?/p>

        <div class="example-box">
            <h5>📝 编码示例</h5>
            <pre>
输入: 16 bits 数据 = 0x5A3C (0101 1010 0011 1100)
�?编码: 7 个三相符�?= [+x, -y, +z, +x, -x, +y, -z]
�?传输: �?3 根信号线 (A, B, C) 上传�?7 �?symbol 周期
            </pre>
            <p><strong>编码效率</strong>: 16 bits / 7 symbols = <strong>2.286 bits/symbol</strong></p>
            <p><strong>实际效率</strong>: 低于理论 2.585 bits/symbol，损�?~12% 用于 DC balance �?clock recovery</p>
        </div>
    ...
    <div class="concept-box">
        ...
        <h5>PCB 设计要求</h5>
        <ul>
            <li><strong>阻抗控制</strong>: 50Ω 单端（�?0%�?/li>
            <li><strong>长度匹配</strong>: Trio �?3 根线长度差异 &lt; 5 mm</li>
            <li><strong>布线建议</strong>: 3 根线尽量靠近，减少串�?/li>
            <li><strong>Via 数量</strong>: 每根�?&lt; 2 �?via</li>
        </ul>
    </div>
    ...
    <div class="warning-box">
        ...
        <p>C-PHY 需要测�?<strong>3 个差分眼�?/strong>：A-B, B-C, C-A</p>
        ...
        <h5>示波器配�?/h5>
        <ul>
            <li><strong>通道�?/strong>: 至少 4 通道�? 单端信号 + 1 时钟恢复�?/li>
            <li><strong>带宽</strong>: �?8 GHz (C-PHY v2.0 @ 5.7 Gbps)</li>
            <li><strong>采样�?/strong>: �?20 GSa/s</li>
...
<div class="section-block">
    <h3>7. MIPI CSI-2 v4.0 / DSI-2 v2.0 新特�?/h3>

    <div class="intro-box">
        <h4>📷 CSI-2 v4.0 �?DSI-2 v2.0 升级</h4>
        <p>最新版本的 <strong>CSI-2 v4.0 (Camera)</strong> �?<strong>DSI-2 v2.0 (Display)</strong> 引入多项增强特性，支持更高分辨率、更高帧率和更灵活的数据格式�?/p>
    </div>

    <h4>7.1 CSI-2 v4.0 核心新特�?/h4>
    <div class="concept-box">
        <table class="reference-table">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td><strong>最�?Lane �?/strong></td>
                    <td>4 Lanes</td>
                    <td><strong>8 Lanes</strong></td>
                    <td>带宽翻�?/td>
                </tr>
                <tr>
                    <td><strong>�?Lane 速率</strong></td>
                    <td>2.5 Gbps</td>
                    <td><strong>4.5 Gbps (D-PHY v3.0)</strong></td>
                    <td>+80%</td>
                </tr>
                <tr>
                    <td><strong>最大聚合带�?/strong></td>
        ...
        <h5>应用场景</h5>
        <ul>
            <li><strong>8K@30fps 视频录制</strong>: 4L@4.5Gbps �?8L@2.5Gbps</li>
            <li><strong>多摄像头系统</strong>: 16 个虚拟通道支持 4 �?4K 摄像头同时传�?/li>
            <li><strong>车载视觉</strong>: 环视 + 前视 + 后视多路摄像头融�?/li>
            <li><strong>工业相机</strong>: 20-bit RAW20 格式支持高精度成�?/li>
        </ul>
    </div>

    <h4>7.2 DSI-2 v2.0 核心新特�?/h4>
    <div class="concept-box">
        <table class="reference-table">
            <thead>
                <tr>
        ...
        <h5>带宽计算示例</h5>
        <div class="formula-box">
            <p><strong>8K@60Hz RGB888 (无压�?</strong>:</p>
            <p>$Bandwidth = 7680 \times 4320 \times 60 \times 3 \times 8 = 47.78\ Gbps$</p>
            <p><strong>DSC 3:1 压缩�?/strong>:</p>
        ...
        <ul>
            ...
            <li><strong>车载中控�?/strong>: 多屏异显（仪表盘 + 中控 + HUD�?/li>
            <li><strong>VR/AR 显示</strong>: 双眼 4K@90Hz 低延�?/li>
        </ul>
    </div>
    ...
    <div class="warning-box">
        ...
        <ul>
            ...
            <li><strong>Skew</strong>: Lane �?skew &lt; 200 ps (CSI-2 �?Lane)</li>
        </ul>

        <h5>协议层测�?/h5>
        <ul>
            <li><strong>Virtual Channel ID</strong>: 验证 16 �?VC 正确路由</li>
            <li><strong>Packet 完整�?/strong>: CRC 校验通过�?100%</li>
            <li><strong>时序验证</strong>: HS-to-LP / LP-to-HS 切换时序符合规范</li>
        </ul>

        <h5>DSC 压缩验证</h5>
        <ul>
            <li><strong>压缩�?/strong>: 验证 3:1 压缩无明显失�?/li>
            <li><strong>解压延迟</strong>: &lt; 1 行扫描时�?/li>
...
<div class="summary-box">
    <h3>�?MIPI 扩展内容总结</h3>
    <ul>
        <li>�?<strong>C-PHY 三相编码</strong>: 2.28× 效率提升�?.71 Gbps/Trio</li>
        <li>�?<strong>16-to-7 编码</strong>: 2.286 bits/symbol 实际效率</li>
        <li>�?<strong>CSI-2 v4.0</strong>: 8 Lanes�?6 虚拟通道、支�?8K@30fps</li>
    ...
    // ==================== LPDDR5X 深度测试与调�?(v2.5.3 新增) ====================
    lpddr5xTestingDeepDive: {
        title: 'LPDDR5X 深度测试与调试技�?(8533MT/s JESD209-5B)',
        icon: 'fa-memory',
        content: `
            <div class="deep-dive-container">
                <h2><i class="fas fa-memory"></i> LPDDR5X 深度测试与调试技�?/h2>

<div class="section-block">
    <h3>第一部分: LPDDR5X 规范概述与核心特�?/h3>

    <div class="intro-box">
        <h4>📖 LPDDR5X 简�?/h4>
        <p><strong>LPDDR5X</strong> �?JEDEC 发布的低功�?DDR 内存标准 JESD209-5B 的最新版本，相比 LPDDR5 提供了更高的数据速率（最�?8533 MT/s）和更低的功耗，主要应用于旗舰智能手机、平板电脑和高性能移动设备�?/p>
    </div>
    ...
    <div class="concept-box">
        ...
        <ul>
            <li>WCK 频率 = 数据速率 / 2 (因为 DDR，每�?WCK 周期传输 2 bits)</li>
            <li>tCK �?CK 时钟周期，tWCK �?WCK 时钟周期</li>
            <li>8533 MT/s 档位�?PCB 设计和信号完整性要求最严格</li>
        </ul>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="warning-box">
            <p><strong>⚠️ 电压域设计注意事�?/strong>:</p>
            <ul>
                <li><strong>上电顺序</strong>: 必须严格遵守 VDD1 �?VDD2H �?VDD2L �?VDDCA �?VDDQ 顺序</li>
                <li><strong>掉电顺序</strong>: 与上电顺序相反，避免 Latch-up</li>
                <li><strong>电压精度</strong>: 每个电压域精度要�?±3%，纹�?< 50mV</li>
                <li><strong>去耦电�?/strong>: 每个电压域需要独立的去耦网�?/li>
    ...
    <div class="concept-box">
        <h5>什么是 WCK?</h5>
        <p><strong>WCK (Write Clock)</strong> �?LPDDR5/5X 引入的专用写时钟信号，用于同�?DQ 数据的读写操作。与传统 DDR 使用单一时钟不同，LPDDR5X 采用 <strong>双时钟架�?/strong>:</p>
        <ul>
            <li><strong>CK (Command Clock)</strong>: 用于命令/地址传输，频率较�?/li>
            <li><strong>WCK (Write Clock)</strong>: 用于数据读写，频率是 CK �?4 �?(WCK:CK = 4:1 模式) �?2 �?(2:1 模式)</li>
        </ul>
        ...
        <div class="formula-box">
            ...
            <p>因为 WCK 是双沿采�?(DDR)，每�?WCK 周期传输 2 bits</p>
        ...
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>- 唤醒延迟 tWCKENL<br>- 需�?WCK2CK sync</td>
                    <td>移动设备<br>间歇性负�?/td>
                </tr>
            </tbody>
        </table>
        ...
        <ul>
            <li><strong>tWCKENL</strong>: WCK 使能到稳定的延迟，典型�?5-10 tCK</li>
            <li><strong>tWCKPRE</strong>: WCK Preamble 时间，用于接收端锁定 WCK</li>
            <li><strong>tWCK2CK</strong>: WCK �?CK 的相位关系，需要通过 Training 校准</li>
        </ul>
    </div>

    <h4>1.5 Bank Group 架构</h4>
    <div class="concept-box">
        <p>LPDDR5X 采用 <strong>8 Bank Groups × 4 Banks = 32 Banks</strong> 架构，相比传�?DDR �?8 Banks 显著增加�?/p>
        ...
        <div class="example-box">
            ...
            <p><strong>场景</strong>: 连续发�?4 �?Activate 命令到不�?Bank</p>
            <p><strong>LPDDR4X (8 Banks)</strong>:</p>
            <ul>
                <li>每个 ACT 间隔 tRRD = 7.5 ns</li>
                <li>总耗时: 3 × 7.5 ns = 22.5 ns</li>
            </ul>
            <p><strong>LPDDR5X (32 Banks, 分布在不�?BG)</strong>:</p>
            <ul>
                <li>不同 BG �?tRRD = 3.75 ns</li>
        ...
        <ul>
            <li><strong>BG[2:0]</strong>: Bank Group 地址 (3 bits, 选择 8 �?BG 之一)</li>
            <li><strong>BA[1:0]</strong>: Bank 地址 (2 bits, 选择 BG 内的 4 �?Bank 之一)</li>
    ...
    <div class="concept-box">
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>DMI[1:0]</td>
                    <td>2 bits</td>
                    <td>Data Mask Invert (可�?</td>
                    <td>用于 DBI �?Data Mask</td>
                </tr>
                <tr>
                    <td>WCK[1:0]_t/c</td>
                    <td>2 对差�?/td>
        ...
        <ul>
            <li>LPDDR5X 使用 <strong>多周期命令编�?/strong>，一个完整命令需�?2 �?CK 周期传输</li>
            <li><strong>Cycle 1</strong>: CA[6:0] = 命令操作�?+ 部分地址</li>
            <li><strong>Cycle 2</strong>: CA[6:0] = 剩余地址�?+ Bank/BG 地址</li>
        </ul>
        ...
        <div class="formula-box">
            ...
            <p>总容�? $128K \times 8 \times 4 \times 1024 \times 16\ bits = 16\ Gb$</p>
        </div>
    </div>
        ...
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>7.5 ns (�?BG)<br>3.75 ns (不同 BG)</td>
                ...
                <tr>
                    ...
                    <td>18 ns</td>
                    <td>Write �?Precharge 延迟</td>
                </tr>
                <tr>
                    <td>tWTR</td>
                    <td>Write to Read Delay</td>
                    <td>10 ns</td>
                    <td>Write �?Read 切换延迟</td>
                </tr>
                <tr>
                    <td>tRTW</td>
                    <td>Read to Write Delay</td>
                    <td>14 tCK</td>
                    <td>Read �?Write 切换延迟</td>
                </tr>
            </tbody>
        </table>

        <div class="warning-box">
            <p><strong>⚠️ 时序违规的后�?/strong>:</p>
            <ul>
                <li><strong>tRCD 不足</strong>: Row 尚未完全激活就发起 Read/Write，导致数据错�?/li>
                <li><strong>tRP 不足</strong>: Precharge 未完成就 Activate，可能损�?Sense Amplifier</li>
                <li><strong>tRAS 不足</strong>: Row 未保持足够时间，数据未稳定写�?/li>
...
<div class="section-block">
    ...
    <div class="intro-box">
        <h4>📖 为什么需要训练序�?</h4>
        <p>�?LPDDR5X 8533MT/s 的高速率下，信号时序裕量非常小（tWCK = 117ps）。PCB 走线长度差异、温度变化、电压偏差都会导致信号到达时间偏移�?strong>训练序列 (Training Sequences)</strong> 通过软件校准来补偿这些物理偏差，确保数据传输的可靠性�?/p>
    </div>

    <h4>2.1 训练序列概览</h4>
    <div class="concept-box">
        <p>LPDDR5X 包含 <strong>4 种主要训练序�?/strong>，必须在初始化时按顺序执行：</p>
        ...
        <div class="warning-box">
            <p><strong>⚠️ 训练顺序不可颠�?/strong>:</p>
            <ul>
                <li>CA Training 必须最先执行，否则后续命令无法正确传输</li>
                <li>Write Leveling 依赖正确�?CA 命令传输</li>
                <li>Read Training 需要正确的 Write 操作来写入测�?Pattern</li>
                <li>WCK2CK Training 需要可靠的 Read/Write 来验证同�?/li>
            </ul>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <p><strong>CA Training</strong> 的目标是校准 CA 信号相对�?CK 时钟�?Setup �?Hold 时间，确�?DRAM 能正确采样命令和地址�?/p>

        <div class="formula-box">
            <p><strong>Setup / Hold Time 定义</strong>:</p>
            <p>$t_{Setup}$: CA 信号�?CK 采样�?<strong>之前</strong> 必须稳定的时�?/p>
            <p>$t_{Hold}$: CA 信号�?CK 采样�?<strong>之后</strong> 必须保持的时�?/p>
            <p><strong>规范要求 (LPDDR5X @ 8533MT/s)</strong>:</p>
            <p>$t_{Setup}$ �?70 ps</p>
            <p>$t_{Hold}$ �?70 ps</p>
            <p>�?Eye Margin: $t_{Setup} + t_{Hold}$ �?140 ps</p>
        </div>
        ...
        <ol>
            <li><strong>进入 CA Training 模式</strong>:
                <ul>
                    <li>Host 发�?MRW (Mode Register Write) 命令使能 CA Training</li>
                    <li>DRAM 进入 CA Training 接收模式</li>
                </ul>
            </li>
            <li><strong>发�?CA Pattern</strong>:
                <ul>
                    <li>Host 通过 CA[6:0] 总线发送已知的测试 Pattern</li>
                    <li>常用 Pattern: <code>0x55</code> (0101010b) �?<code>0xAA</code> (1010101b) 交替</li>
                    <li>Pattern 涵盖所�?CA 位的 0�? �?1�? 转换</li>
                </ul>
            </li>
            <li><strong>DRAM 回读结果</strong>:
                <ul>
                    <li>DRAM 将接收到�?CA Pattern 通过 DQ[6:0] 回传�?Host</li>
                    <li>Host 对比发送和接收�?Pattern</li>
                </ul>
            </li>
            ...
            <li><strong>计算 Eye Center</strong>:
                <ul>
                    ...
                    <li>设置 CA 延迟�?Eye Center</li>
                </ul>
            </li>
            <li><strong>退�?CA Training</strong>:
                <ul>
                    <li>发�?MRW 退�?CA Training 模式</li>
                    <li>DRAM 恢复正常操作模式</li>
                </ul>
            </li>
        </ol>
        ...
        <div class="example-box">
            ...
            <ul>
                ...
                <li>Eye Width: 180 - 40 = 140 ps �?(满足 �?40ps 要求)</li>
        ...
        <div class="warning-box">
            <p><strong>�?失败场景 1: �?Pass Window (全部 Fail)</strong></p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>CA 信号完整性严重劣�?(PCB 设计问题、过孔过多、走线过�?</li>
                <li>CK 时钟抖动过大，Setup/Hold Margin 完全耗尽</li>
                <li>VDDCA 电压不稳定或超出规范</li>
                <li>DRAM 未正确进�?CA Training 模式 (MRW 命令失败)</li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>使用示波器测�?CA �?CK 信号眼图，检查信号质�?/li>
                <li>测量 CK Jitter，确�?< 20ps (RMS)</li>
                <li>检�?VDDCA 电压和纹�?/li>
                <li>尝试降低 CK 频率 (例如�?8533MT/s 降到 6400MT/s) 验证</li>
            </ol>

            <p><strong>�?失败场景 2: Pass Window 过窄 (< 100ps)</strong></p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>CA 走线长度匹配不佳 (不同 CA 位长度差�?> 50 mil)</li>
                <li>CK �?CA �?skew 过大</li>
                <li>温度极端情况下时序裕量不�?/li>
            </ul>
            <p><strong>解决方案</strong>:</p>
            <ul>
                <li>优化 PCB Layout，改�?CA 长度匹配 (within ±10 mil)</li>
                <li>添加 series termination 电阻改善信号完整�?/li>
                <li>调整 CK Slew Rate (过快会增�?jitter，过慢会增加 ISI)</li>
            </ul>

            <p><strong>�?失败场景 3: 不同 CA �?Eye Center 差异�?(> 50ps)</strong></p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>CA 走线长度严重不匹�?/li>
                <li>不同 CA 位驱动强度不一�?(PHY 配置问题)</li>
                <li>PCB 走线拓扑不对�?(部分 CA 经过 via，部分不经过)</li>
            </ul>
            <p><strong>解决方案</strong>:</p>
            <ul>
                <li>检查并修正 PCB Layout 长度匹配</li>
                <li>确保所�?CA 位使用相同的驱动强度配置</li>
                <li>统一 PCB 走线拓扑 (所�?CA 都使用相同的层间转换)</li>
            </ul>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <p><strong>Write Leveling</strong> 的目标是调整 DQS (Data Strobe) 相位，使其与 CK 时钟对齐，确�?DRAM 能正确采样写入的数据�?/p>

        <p><strong>为什么需�?Write Leveling?</strong></p>
        <ul>
            <li>DQS �?CK 走线长度不同，导致到�?DRAM 的时间不�?/li>
            <li>Host �?DRAM 之间的飞行时�?(flight time) 不可预知</li>
            <li>需要通过训练来动态补偿这个时间差</li>
        </ul>

        <div class="formula-box">
            <p><strong>Write Leveling 目标</strong>:</p>
            <p>调整 DQS 延迟，使得在 DRAM �?</p>
            <p>$DQS\ edge \approx CK\ edge \pm 0.25 \times t_{CK}$</p>
            <p>�?DQS 边沿�?CK 边沿对齐，或相差 1/4 周期 (90度相位差)</p>
        </div>
        ...
        <ol>
            <li><strong>进入 Write Leveling 模式</strong>:
                <ul>
                    <li>发�?MRW 命令使能 Write Leveling</li>
                    <li>DRAM �?DQ 配置为输出模式，回传采样结果</li>
                </ul>
            </li>
            <li><strong>发�?DQS Preamble</strong>:
                <ul>
                    <li>Host 发�?DQS 信号 (持续翻转的时�?</li>
            ...
            <li><strong>读取采样结果</strong>:
                <ul>
                    ...
                    <li>如果 DQ[0] = 0: DQS �?CK 上升沿时为低</li>
                    <li>如果 DQ[0] = 1: DQS �?CK 上升沿时为高</li>
                </ul>
            </li>
            <li><strong>调整 DQS 延迟</strong>:
                <ul>
                    <li>增加 DQS 延迟，重复步�?2-3</li>
                    <li>记录 DQ[0] �?0 �?1 转换�?(DQS 上升沿对�?CK 上升�?</li>
                </ul>
            </li>
            <li><strong>设置最终延�?/strong>:
                <ul>
                    <li>�?0�? 转换点再增加 0.25 tCK 延迟</li>
                    <li>�?DQS 中心对齐�?CK (90度相�?</li>
                </ul>
            </li>
        </ol>
        ...
        <div class="example-box">
            ...
            <table class="reference-table">
                ...
                <tbody>
                    ...
                    <tr><td>150</td><td>1</td><td>�?转换�? DQS 上升沿对�?CK</td></tr>
            ...
            <ul>
                ...
                <li>此时 DQS 中心对齐�?CK，DRAM 能正确采样写入数�?/li>
            </ul>
        </div>
        ...
        <div class="warning-box">
            ...
            <p><strong>现象</strong>:</p>
            <ul>
                <li>多次运行 Write Leveling�?�? 转换点每次相�?> 30ps</li>
                <li>导致写入操作间歇性失�?/li>
            </ul>
            <p><strong>根因分析</strong>:</p>
            <ul>
                <li>CK 时钟 jitter 过大 (测量�?32ps RMS，规范要�?< 20ps)</li>
                <li>DRAM 采样 DQS 时，CK 边沿位置不稳�?/li>
            </ul>
            <p><strong>解决方案</strong>:</p>
            <ol>
                <li>检�?CK 时钟�?(PLL)，发�?PLL 带宽配置过高</li>
                <li>调整 PLL 带宽�?1MHz，CK jitter 降至 12ps �?/li>
                <li>重新运行 Write Leveling，转换点稳定�?150 ± 5ps</li>
    ...
    <div class="concept-box">
        ...
        <p><strong>Read Training �?Write Leveling 的区�?/strong>:</p>
        <table class="reference-table">
            <thead>
                <tr>
                    <th>特�?/th>
        ...
        <div class="formula-box">
            ...
            <p>对于每个 DQ bit，调�?RX 采样延迟，使�?</p>
            <p>$t_{sample} = t_{DQS\_edge} + 0.5 \times t_{UI}$</p>
            <p>即在 DQS 边沿后半�?UI 的位置采�?(眼图中心)</p>
        </div>

        <h5>2.4.2 Read Training 流程 (MPR Pattern 方法)</h5>
        <ol>
            <li><strong>写入已知 Pattern �?DRAM</strong>:
                <ul>
                    <li>使用 Write 命令将测�?Pattern 写入 DRAM</li>
                    <li>常用 Pattern: <code>0x55555555</code> �?<code>0xAAAAAAAA</code></li>
                </ul>
            </li>
            <li><strong>配置 MPR (Multi-Purpose Register) 模式</strong>:
                <ul>
                    <li>DRAM 进入 MPR 模式，不断输出预定义�?Pattern</li>
            ...
            <li><strong>扫描 DQ 采样延迟</strong>:
                <ul>
                    ...
                    <li>每个延迟点执�?Read 操作，对比读取值和期望�?/li>
                </ul>
            </li>
            <li><strong>记录 Pass Window</strong>:
                <ul>
                    <li>记录每个 DQ bit �?Pass 范围 (First Pass ~ Last Pass)</li>
                    <li>计算 Eye Center = (First Pass + Last Pass) / 2</li>
                </ul>
            </li>
            <li><strong>设置最终延�?/strong>:
                <ul>
                    <li>将每�?DQ bit �?RX 采样延迟设置到各自的 Eye Center</li>
                </ul>
            </li>
            <li><strong>退�?MPR 模式</strong>:
                <ul>
                    <li>DRAM 退�?MPR，恢复正常读写操�?/li>
                </ul>
            </li>
        </ol>
        ...
        <div class="example-box">
            ...
            <table class="reference-table">
                ...
                <tbody>
                    <tr><td>0</td><td>不稳�?/td><td>-</td><td>�?Fail</td></tr>
                    <tr><td>20</td><td>不稳�?/td><td>-</td><td>�?Fail</td></tr>
        ...
        <p>由于 PCB 走线长度差异、DRAM 输出 skew 等因素，不同 DQ bit 的最佳采样延迟不同�?strong>Per-bit Deskew</strong> 为每�?bit 单独校准�?/p>
        ...
        <p><strong>分析</strong>:</p>
        <ul>
            <li>8 �?DQ bit �?Eye Center 范围: 65ps ~ 75ps，最大差�?10ps</li>
            <li>所�?bit Eye Width 一�?(60ps)，说明信号质量良�?/li>
            <li>通过 Per-bit Deskew，每�?bit 都获�?±30ps �?Margin �?/li>
        </ul>
        ...
        <div class="warning-box">
            ...
            <ul>
                <li><strong>可能原因</strong>: �?bit 走线过长、过孔过多、或有串�?/li>
                <li><strong>解决</strong>: 检�?PCB Layout，优化该 bit 走线</li>
            </ul>

            <p><strong>问题 2: 所�?DQ bit Eye Width 都很�?(< 0.3 UI)</strong></p>
            <ul>
                <li><strong>可能原因</strong>: DQS 信号质量差、ODT 设置不当、或 VDDQ 不稳�?/li>
                <li><strong>解决</strong>: 测量 DQS 眼图，调�?ODT 阻值，检�?VDDQ 电源</li>
            </ul>

            <p><strong>问题 3: 温度变化�?Eye Center 漂移 > 20ps</strong></p>
            <ul>
                <li><strong>可能原因</strong>: PCB 材料�?Dk (介电常数) 温度系数�?/li>
    ...
    <div class="concept-box">
        ...
        <p><strong>WCK2CK Training</strong> 的目标是同步 WCK (Write Clock) �?CK (Command Clock)，确�?DRAM 内部�?WCK 相位�?CK 保持正确关系�?/p>

        <p><strong>为什么需�?WCK2CK Training?</strong></p>
        <ul>
            <li>LPDDR5X 使用独立�?WCK �?CK 时钟</li>
            <li>WCK 频率�?CK �?4 �?(4:1 模式) �?2 �?(2:1 模式)</li>
            <li>DRAM 内部需要知�?WCK 的哪个边沿对�?CK 的边�?/li>
            <li>如果不同步，读写时序会完全错�?/li>
        </ul>
        ...
        <div class="formula-box">
            ...
            <p>即每 4 �?WCK 上升沿对�?1 �?CK 上升�?/p>
            <p>Training 的目标是找到这个对应关系并锁�?/p>
        </div>
        ...
        <ol>
            <li><strong>使能 WCK</strong>:
                <ul>
                    <li>如果 WCK 处于 Fast-Wake 模式 (关闭状�?，先使能 WCK</li>
                    <li>等待 tWCKENL (WCK 稳定时间，约 5-10 tCK)</li>
                </ul>
            </li>
            <li><strong>发�?WCK2CK Sync 命令</strong>:
                <ul>
                    <li>Host 发送特殊的 MPC (Multi-Purpose Command) 触发同步</li>
                    <li>DRAM 进入 WCK2CK Sync 模式</li>
                </ul>
            </li>
            <li><strong>DRAM 内部相位检�?/strong>:
                <ul>
                    <li>DRAM 使用 CK 采样 WCK，判断当�?WCK 相位</li>
                    <li>确定 WCK 的哪个边沿应该对�?CK 上升�?/li>
                </ul>
            </li>
            <li><strong>锁定相位</strong>:
                <ul>
                    <li>DRAM 内部 DLL 锁定 WCK �?CK 的相位关�?/li>
                    <li>完成�?DRAM 回复 ACK (通过 DQ 总线)</li>
                </ul>
            </li>
            <li><strong>验证同步</strong>:
                <ul>
                    <li>Host 发起 Write-Read 循环测试</li>
                    <li>如果 WCK2CK 同步正确，数据读写无�?/li>
                    <li>如果同步失败，数据错�?/li>
                </ul>
            </li>
        </ol>
        ...
        <div class="warning-box">
            <p><strong>�?案例: WCK2CK Sync 后数据仍然错�?/strong></p>
            <p><strong>现象</strong>:</p>
            <ul>
                <li>执行 WCK2CK Training，DRAM 返回 ACK</li>
                <li>�?Write-Read 测试中，读取数据完全错误 (bit 位置错乱)</li>
                <li>例如写入 <code>0x12345678</code>，读�?<code>0x34127856</code> (循环移位)</li>
            </ul>
            <p><strong>根因分析</strong>:</p>
            <ul>
                <li>WCK �?CK 的走线长度差异过�?(测量�?1200 mil vs 800 mil，差 400 mil)</li>
                <li>WCK 到达 DRAM �?CK 晚约 1.2 ns �?5 × tCK</li>
                <li>DRAM 内部相位检测误判，锁定到错误的 WCK 边沿</li>
            </ul>
            <p><strong>解决方案</strong>:</p>
            <ol>
                <li>测量 WCK �?CK �?DRAM 端的相对到达时间</li>
                <li>调整 PHY �?WCK 的输出延迟，补偿走线长度差异</li>
                <li>�?WCK 输出延迟增加 1.2 ns，使 WCK �?CK 同时到达 DRAM</li>
                <li>重新运行 WCK2CK Training</li>
                <li>验证: Write-Read 测试 1000/1000 通过 �?/li>
            </ol>
            <p><strong>预防措施</strong>:</p>
            <ul>
                <li>PCB 设计时，WCK �?CK 走线长度差应 < 100 mil</li>
                <li>如果无法避免长度差，�?PHY 配置中提前补�?/li>
            </ul>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <p><strong>重要说明</strong>:</p>
        <ul>
            <li><strong>CA, Write Leveling, Read Training</strong> 在系统上电时执行一次即�?/li>
            <li><strong>WCK2CK Training</strong> 需要在每次 WCK 从关闭到使能时重新执�?(Fast-Wake 模式)</li>
            <li>如果环境温度变化 > 20°C，建议重新执�?Read Training</li>
...
<div class="section-block">
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            <p><strong>功耗计�?(WCK Always-On vs Fast-Wake)</strong>:</p>
            <p>假设工作周期 (Duty Cycle) = 10% (�?90% 时间空闲)</p>
            <p>Always-On 平均功�? $P_{avg} = P_{WCK} \times 100\% = 100\ mW$ (假设)</p>
            <p>Fast-Wake 平均功�? $P_{avg} = P_{WCK} \times 10\% + P_{idle} \times 90\%$</p>
            <p>$= 100 \times 0.1 + 5 \times 0.9 = 10 + 4.5 = 14.5\ mW$</p>
            <p><strong>功耗节�?/strong>: $(100 - 14.5) / 100 = 85.5\%$ �?/p>
        </div>
    </div>

    <h4>3.2 WCK Jitter 要求与测�?/h4>
    <div class="concept-box">
        <table class="reference-table">
            <thead>
                <tr>
        ...
        <ol>
            <li>使用高带宽示波器 (�?0 GHz) 和差分探头测�?WCK_t/WCK_c</li>
            <li>触发方式: 使用 WCK 自身边沿触发</li>
            <li>采集时长: �?1M WCK 周期 (�?234 μs @ 4266MHz)</li>
            <li>Jitter 分析: 使用示波�?Jitter 分析软件�?/li>
            <li>验证: TJ @ BER 10<sup>-12</sup> �?6.0 ps</li>
        </ol>

        <div class="warning-box">
            <p><strong>⚠️ WCK Jitter 过大的后�?/strong>:</p>
            <ul>
                <li>DQ 采样点偏移，导致读写误码</li>
                <li>WCK2CK Training 不稳定，需频繁重训</li>
                <li>极端情况下无法完�?WCK2CK Sync</li>
            </ul>
            <p><strong>Jitter 优化措施</strong>:</p>
            <ul>
                <li>使用低噪�?PLL 生成 WCK (相位噪声 < -130 dBc/Hz @ 1MHz)</li>
                <li>WCK 走线避免跨分割、远离强干扰�?/li>
...
<div class="section-block">
    ...
    <div class="concept-box">
        ...
        <ul>
            <li>�?16 bits DQ 数据编码�?18 bits (16 DQ + 2 DMI)</li>
            <li>使用 Hamming Code �?BCH Code 生成 2-bit ECC</li>
            <li>接收端解码，可纠�?1-bit 错误、检�?2-bit 错误</li>
        </ul>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="example-box">
            <h5>📝 Link ECC 实际效果</h5>
            <p><strong>测试场景</strong>: 8533MT/s, 高温 85°C, 长走�?(15 cm)</p>
            ...
            <ul>
                <li>测试时长: 1 小时</li>
                <li>误码�? 0 errors (所有单bit错误被纠�? �?/li>
                <li>BER < 10<sup>-18</sup> (未观察到不可纠正错误)</li>
            </ul>
            <p><strong>结论</strong>: Link ECC 在高速率、长走线场景下显著提升可靠�?/p>
        </div>
    </div>
</div>
...
<div class="section-block">
    ...
    <div class="concept-box">
        ...
        <div class="warning-box">
            <p><strong>⚠️ 电压摆幅不足的后�?/strong>:</p>
            <ul>
                <li><strong>摆幅过小</strong>: 信噪比下降，容易受噪声影响，误码率上�?/li>
                <li><strong>摆幅过大</strong>: 功耗增加，SI 问题加剧 (振铃、过�?</li>
            </ul>
        </div>
    </div>
    ...
    <div class="concept-box">
        <p><strong>ODT 作用</strong>: 在接收端提供匹配阻抗，吸收反射，改善信号完整�?/p>
        ...
        <div class="formula-box">
            ...
            <p>但实际需要平衡功耗，长走线常�?ODT-48Ω �?60Ω</p>
        </div>
    </div>
</div>
...
<div class="section-block">
    ...
    <div class="concept-box">
        ...
        <ul>
            ...
            <li>末端 DRAM 需�?series termination (�?40Ω 电阻)</li>
            <li>不同 DRAM �?CA Training 结果会不同，需分别校准</li>
        </ul>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="warning-box">
            <p><strong>⚠️ 阻抗失配的后�?/strong>:</p>
            <ul>
                <li><strong>阻抗过高</strong>: 信号衰减大，幅度不足</li>
                <li><strong>阻抗过低</strong>: 反射系数增大，振铃严�?/li>
                <li><strong>不同信号阻抗不一�?/strong>: 不同 bit 时序偏差，眼图不对称</li>
            </ul>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            <p><strong>时延与走线长度换�?/strong>:</p>
            <p>对于 FR4 PCB (相对介电常数 $\varepsilon_r = 4.2$):</p>
            <p>$t_{delay} = \frac{L}{v} = \frac{L}{c / \sqrt{\varepsilon_r}} = \frac{L \sqrt{\varepsilon_r}}{c}$</p>
            <p>其中 $c = 3 \times 10^8\ m/s$ (光�?</p>
            <p>简�? $t_{delay}\ (ps) \approx 6.7 \times L\ (mm)$</p>
            <p>例如: 10 mm 走线长度差异 �?67 ps 时延差异</p>
        </div>

        <p><strong>长度匹配实现方法</strong>:</p>
        <ul>
            <li><strong>Serpentine routing</strong>: 短走线增加蛇形绕线补偿长�?/li>
            <li><strong>Trombone routing</strong>: U 型绕线补�?/li>
            <li><strong>Phase tuning</strong>: PHY 侧软件延迟调�?(补充 PCB 匹配不足)</li>
        </ul>
    </div>

    <h4>6.4 电源平面设计</h4>
    <div class="concept-box">
        <p><strong>去耦电容配置建�?(单片 LPDDR5X)</strong>:</p>
        ...
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>靠近 DRAM VDD2H pin<br>分布�?个角</td>
                </tr>
                <tr>
                    <td>VDD2L (0.5V)</td>
                    <td>10μF<br>1μF<br>0.1μF</td>
        ...
        <ul>
            <li>VDD1, VDD2H, VDD2L, VDDCA, VDDQ 使用独立的电源平�?(不同�?</li>
            <li>每个电源平面下方有完整的 GND 平面</li>
            <li>高速信�?(DQ/DQS/WCK) 走在 VDDQ 平面上方，参�?VDDQ �?GND</li>
...
<div class="section-block">
    ...
    <div class="concept-box">
        <p><strong>Bank Interleaving</strong>: 将连续访问分散到不同 Bank Group，利�?Bank 并发性提升带宽�?/p>

        <div class="example-box">
            <h5>📝 Bank Interleaving 性能对比</h5>
            <p><strong>场景</strong>: 连续读取 128 KB 数据</p>

            <p><strong>不使�?Interleaving</strong> (顺序访问同一 Bank):</p>
            <ul>
                <li>每次 Read 后需等待 tRTP + tRP (�?30 ns) 才能下一�?Activate</li>
            ...
            <ul>
                <li>在不�?BG 间切换，tRRD = 3.75 ns (不同 BG 间延迟短)</li>
        ...
        <ul>
            <li>地址映射时，将连续地址映射到不�?BG</li>
            <li>例如: Addr[2:0] �?BG[2:0]，使连续 8 个访问分散到 8 �?BG</li>
            <li>内存控制器调度算法优先选择不同 BG 的请�?/li>
        </ul>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            ...
            <p>假设 DRAM 需要每 32 ms 完整刷新一�?(128K rows)</p>
            <p><strong>All-Bank Refresh</strong>:</p>
            <p>刷新次数: 128K / 8K = 16 �?/p>
            <p>刷新总时�? 16 × 280 ns = 4.48 μs</p>
            <p>带宽损失: 4.48 / 32000 = 0.014% (可忽�?</p>

            <p><strong>但是</strong>: 每次刷新阻塞时间�?(280 ns)，影�?QoS</p>

            <p><strong>Fine Granularity Refresh</strong>:</p>
            <p>刷新次数: 128K / 1K = 128 �?/p>
            <p>刷新总时�? 128 × 70 ns = 8.96 μs</p>
            <p>带宽损失: 8.96 / 32000 = 0.028% (略高但可接受)</p>
            <p><strong>优势</strong>: 每次阻塞时间�?(70 ns)，QoS 更好 �?/p>
        </div>
    </div>
</div>

<div class="section-block">
    <h3>第八部分: 调试案例�?(10个实战案�?</h3>

    <h4>案例 1: CA Training 失败导致启动挂死</h4>
    <div class="example-box">
        <p><strong>现象</strong>: 系统上电后，LPDDR5X 初始化过程中卡死，串口无任何输出</p>
        <p><strong>初步分析</strong>: 使用逻辑分析仪抓�?CA 总线，发�?Host 持续发�?CA Training Pattern，但 DRAM 无响�?/p>
        <p><strong>根因定位</strong>:</p>
        <ol>
            <li>测量 CA 信号眼图，发�?CA3 信号眼图完全闭合 (Eye Width < 10ps)</li>
            <li>检�?PCB Layout，发�?CA3 走线经过 4 个过孔，而其�?CA �?1-2 �?/li>
            <li>过多过孔导致反射�?ISI 严重，信号质量劣�?/li>
        </ol>
        <p><strong>解决方案</strong>:</p>
        <ul>
            <li>Rework PCB: 重新布线 CA3，减少至 2 个过�?/li>
            <li>重新测量眼图: Eye Width 恢复�?80ps �?/li>
            <li>CA Training 成功通过，系统正常启�?/li>
        </ul>
    </div>

    <h4>案例 2: 特定数据 Pattern 读取错误</h4>
    <div class="example-box">
        <p><strong>现象</strong>: 写入 <code>0x00000000</code> �?<code>0xFFFFFFFF</code> 正常，但写入 <code>0xAAAAAAAA</code> 读取错误</p>
        <p><strong>分析</strong>: 0xAAAAAAAA 是最高频 pattern (每个 bit 都翻�?，对信号完整性要求最�?/p>
        <p><strong>根因定位</strong>:</p>
        <ol>
            <li>测量 DQ 眼图，发现高频下眼高仅剩 200mV (规范要求 263mV)</li>
            <li>检�?ODT 设置，发现设置为 ODT-80Ω (阻抗过高，反射大)</li>
        </ol>
        <p><strong>解决方案</strong>:</p>
        <ul>
            <li>调整 ODT �?ODT-48Ω (更匹�?40Ω PCB trace)</li>
            <li>重新测量眼高: 恢复�?310mV �?/li>
    ...
    <div class="example-box">
        <p><strong>现象</strong>: 室温 (25°C) 测试正常，高�?(85°C) 出现间歇性误�?/p>
        <p><strong>分析</strong>: 高温�?PCB 材料介电常数变化，信号传播速度改变，时序偏�?/p>
        <p><strong>根因定位</strong>:</p>
        <ol>
            <li>�?85°C 重新运行 Read Training，发�?Eye Center 相比 25°C 偏移 25ps</li>
            <li>初始训练�?25°C 进行，高温下偏移超出 Setup/Hold Margin</li>
        </ol>
        <p><strong>解决方案</strong>:</p>
        <ul>
            <li>实现 Periodic Retraining: 每隔 30 秒或温度变化 > 10°C 时重新训�?/li>
            <li>高温下误码率降至 0 �?/li>
        </ul>
    </div>
    ...
    <div class="example-box">
        <p><strong>现象</strong>: WCK2CK Sync 命令发送后，DRAM 长时间不返回 ACK，最终超时失�?/p>
        <p><strong>根因定位</strong>:</p>
        <ol>
            <li>测量 WCK �?CK �?DRAM 端的相位关系，发现相位差每次都不�?(±50ps 抖动)</li>
            <li>检�?WCK PLL，发�?Loop Filter 电容容值选择过小，PLL 带宽过高 (10 MHz)</li>
            <li>高带宽导�?PLL 对电源噪声敏感，WCK 相位噪声�?/li>
        </ol>
        <p><strong>解决方案</strong>:</p>
        <ul>
    ...
    <div class="example-box">
        <p><strong>现象</strong>: Link ECC 使能后，系统日志频繁报告 Single-bit Error (SEC) 被纠正，约每分钟 10 �?/p>
        <p><strong>分析</strong>: 虽然错误被纠正，不影响数据正确性，但高错误率说明链路质量差</p>
        <p><strong>根因定位</strong>:</p>
        <ol>
            <li>分析错误分布，发�?90% 错误集中�?DQ8-DQ15 (Byte 1)</li>
            <li>测量 DQS1 信号，发现有明显的周期性噪�?(频率 ~100 MHz)</li>
            <li>追踪噪声源，发现 PCB �?DQS1 走线�?100 MHz 时钟走线平行走了 5 cm</li>
            <li>串扰导致 DQS1 采样点偏移，数据误码</li>
        </ol>
        <p><strong>解决方案</strong>:</p>
        <ul>
            <li>Rework: DQS1 走线改为垂直跨越时钟走线，减少平行走线长度至 < 1 cm</li>
            <li>Link ECC 错误率降至每小时 < 1 �?�?/li>
        </ul>
    </div>

    <h4>案例 6-10: 简要说�?/h4>
    <div class="concept-box">
        <p><strong>案例 6: 功耗异常偏�?/strong> - 发现 WCK Always-On 模式误配置，改为 Fast-Wake 后功耗降�?75%</p>
        <p><strong>案例 7: 眼图 Margin 不足</strong> - VDDQ 电源纹波过大 (150mV)，增加去耦电容后纹波降至 30mV，Eye Margin 改善</p>
        <p><strong>案例 8: 刷新率设置不�?/strong> - 使用默认 32ms 刷新周期，高温下数据损坏，改�?16ms 后稳�?/p>
        <p><strong>案例 9: ZQ Calibration 失效</strong> - ZQ pin 外部电阻选择错误 (200Ω 而非 240Ω)，导致驱动强度偏�?/p>
        <p><strong>案例 10: �?Rank 配置串扰</strong> - 两个 Rank �?DQS 走线距离过近 (< 3W spacing)，增加间距至 5W 后解�?/p>
    </div>
</div>
    ...
    <ul>
        ...
        <li><strong>测试指南</strong>:
            <ul>
                ...
                <li>�?DRAM 厂商�?Datasheet (Micron, Samsung, SK hynix)</li>
            </ul>
        </li>
        <li><strong>设计参�?/strong>:
            <ul>
...
<div class="summary-box">
    <h3>�?LPDDR5X 章节总结</h3>
    <p>本章节完整讲解了 LPDDR5X (JESD209-5B, 最�?8533MT/s) 的技术体系，包括:</p>
    <ul>
        <li>�?规范概述: 速率档位、电压域、WCK 机制、Bank Group 架构</li>
        <li>�?训练序列: CA Training、Write Leveling、Read Training、WCK2CK Training (800行详�?</li>
        <li>�?WCK 深度解读: Always-On vs Fast-Wake、Jitter 要求</li>
        <li>�?Link ECC 机制: On-die ECC vs Link ECC、可靠性提�?/li>
        <li>�?电气特性与测试: 电压摆幅、眼图测试、ODT 配置</li>
        <li>�?PCB 设计要求: 拓扑结构、阻抗控制、长度匹配、电源平�?/li>
        <li>�?性能优化技�? Bank Interleaving、Refresh Management</li>
        <li>�?调试案例�? 10 个真实项目问题排查实�?/li>
    </ul>
    <p><strong>总内容量</strong>: �?2,200 行专业级深度技术内�?�?/p>
</div>
...
,
    ...
    displayPortTestingDeepDive: {
        title: 'DisplayPort 深度测试技�?(DP 2.1 UHBR)',
        icon: 'fa-desktop',
        content: `
            <div class="deep-dive-container">
                <h2><i class="fas fa-desktop"></i> DisplayPort 深度测试技�?/h2>

                <div class="section-block">
                    <h3>1. DisplayPort 2.1 UHBR 超高比特率详�?/h3>

                    <div class="intro-box">
                        <h4>🚀 DP 2.1 革命性升�?/h4>
                        <p><strong>DisplayPort 2.1</strong> 引入 <strong>UHBR (Ultra High Bit Rate)</strong>，支持最�?<strong>80 Gbps</strong> 带宽，可驱动 16K@60Hz �?4K@240Hz 显示器，并首次支�?DP over USB Type-C (DP Alt Mode on USB4)�?/p>
                    </div>
                    ...
                    <div class="concept-box">
                        ...
                        <div class="formula-box">
                            ...
                            <p>相比 HBR3 �?8b/10b (80% 效率)，提�?<strong>21.25%</strong></p>
                        </div>
                    </div>

                    <h4>1.2 DP 2.1 Link Training 三阶段详�?/h4>
                    <div class="concept-box">
                        <h5>Link Training 目的</h5>
                        <p>DP Link Training 是建立稳定高速连接的关键流程，包�?Clock Recovery、Channel Equalization �?Symbol Lock 三个阶段�?/p>

                        <div class="example-box">
                            <h5>Phase 1: Clock Recovery (CR)</h5>
                            <ol>
                                <li><strong>Source 发�?/strong>: CR Training Pattern (TPS1 - 连续 1010 pattern)</li>
                                <li><strong>Sink 任务</strong>: CDR (Clock Data Recovery) 锁定�?lane bit clock</li>
                                <li><strong>判断标准</strong>: 连续接收 100 个符号无误码</li>
                                <li><strong>成功标志</strong>: Sink 设置 CR_DONE �?(DPCD 0x202)</li>
                                <li><strong>超时时间</strong>: 最�?500 μs</li>
                            </ol>
                        </div>
                        ...
                        <div class="example-box">
                            ...
                            <ol>
                                <li><strong>Source 发�?/strong>: EQ Training Pattern (TPS2/3/4 - PRBS pattern)</li>
                                <li><strong>Sink 任务</strong>: 调整 RX 均衡器系�?(CTLE, DFE)</li>
                                ...
                                <li><strong>成功标准</strong>: 所�?lane �?CHANNEL_EQ_DONE �?SYMBOL_LOCKED 位置�?/li>
                                <li><strong>超时时间</strong>: 最�?400 μs</li>
                            </ol>
                        </div>

                        <div class="example-box">
                            <h5>Phase 3: Symbol Lock �?Interlane Align</h5>
                            <ol>
                                <li><strong>Symbol Lock</strong>: 确定 128b block 边界 (DP 2.x)</li>
                                <li><strong>Interlane Alignment</strong>: 对齐 4 �?lane �?symbol 边界（补�?PCB skew�?/li>
                                <li><strong>BS (Blanking Start) 检�?/strong>: 识别 DP 数据流的帧起�?/li>
                                <li><strong>成功标志</strong>: INTERLANE_ALIGN_DONE 位置�?/li>
                            </ol>
                            <p><strong>�?Link Training 时间</strong>: 通常 1-3 ms</p>
                        </div>
...
[正常传输视频/音频数据]
                    ...
                    <div class="warning-box">
                        ...
                        <ul>
                            ...
                            <li><strong>EQ Iterations</strong>: Phase 2 迭代次数 &lt; 5 �?/li>
                            <li><strong>DPCD 0x202-0x207</strong>: 读取所�?lane �?training 状态位</li>
                ...
                <div class="section-block">
                    ...
                    <div class="intro-box">
                        ...
                        <p><strong>DP Alt Mode</strong> 允许 DP 信号通过 USB Type-C 接口传输，复�?USB 3.x �?SuperSpeed 差分对传�?DP lanes，实现单线缆视频+数据+充电�?/p>
                    </div>
                    ...
                    <div class="example-box">
                        <ol>
                            <li><strong>Type-C 插入检�?/strong>: CC pin 识别 DFP/UFP 角色</li>
                            ...
                            <li><strong>DP Config</strong>: 选择 2-Lane �?4-Lane 配置</li>
                            <li><strong>MUX 切换</strong>: Type-C MUX �?USB lanes 切换�?DP 模式</li>
                            <li><strong>DP Link Training</strong>: 执行标准 DP 训练流程</li>
                            <li><strong>视频传输</strong>: 开始传�?DP 视频�?/li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="summary-box">
                    ...
                    <ul>
                        <li>�?<strong>DP 2.1 UHBR</strong>: 最�?80 Gbps、支�?16K@60Hz</li>
                        <li>�?<strong>Link Training 三阶�?/strong>: CR �?EQ �?Interlane Align</li>
                        <li>�?<strong>DP Alt Mode</strong>: USB Type-C 单线缆视频传�?/li>
                        <li>�?<strong>测试要点</strong>: 眼图、Jitter、DPCD 状态位</li>
                    </ul>
                </div>

<div class="section-block">
    <h3>2. DP 2.1 UHBR PHY 层深度解�?/h3>
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            ...
            <p><strong>支持分辨�?/strong>: 16K@60Hz (RGB 8-bit) 需�?~75 Gbps �?/p>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <p>DP 规范定义 <strong>4 个电压摆幅等�?(Voltage Swing)</strong> �?<strong>4 个预加重等级 (Pre-emphasis)</strong>，共 10 种有效组合�?/p>
        ...
        <div class="warning-box">
            <p><strong>⚠️ 预加重调节策�?/strong>:</p>
            <ul>
                <li><strong>短线�?(<1m)</strong>: Swing Level 2-3, Pre-emphasis Level 0-1</li>
                <li><strong>中等线缆 (1-2m)</strong>: Swing Level 1-2, Pre-emphasis Level 1-2</li>
                <li><strong>长线�?(>2m)</strong>: Swing Level 0-1, Pre-emphasis Level 2-3</li>
                <li><strong>Link Training 失败</strong>: 逐步提升 pre-emphasis，降�?swing</li>
            </ul>
        </div>

        <h5>RX 端均�?(CTLE + DFE)</h5>
        <ul>
            <li><strong>CTLE (Continuous Time Linear Equalizer)</strong>: 补偿高频衰减，提升高频增�?/li>
            <li><strong>DFE (Decision Feedback Equalizer)</strong>: 消除 ISI (Inter-Symbol Interference)，抑制拖�?/li>
        </ul>

        <div class="example-box">
            <h5>📝 UHBR20 均衡实例</h5>
            <p><strong>场景</strong>: 2m DP 线缆，UHBR20 模式</p>
            <p><strong>初始眼图</strong>: Eye Height = 30 mV (不满�?>45 mV 要求)</p>
            ...
            <p><strong>调整后眼�?/strong>: Eye Height = 62 mV �?满足要求</p>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <p><strong>Adaptive Sync (自适应同步)</strong> 允许显示器动态调整刷新率以匹�?GPU 输出帧率，消除撕裂和卡顿。DP 1.2a 引入，DP 2.1 进一步增强�?/p>

        <div class="formula-box">
            <p><strong>VRR 范围计算</strong>:</p>
            <p>$V_{total} = V_{active} + V_{blanking}$</p>
            <p>$Refresh\,Rate = \frac{Pixel\,Clock}{H_{total} \times V_{total}}$</p>
            <p><strong>示例</strong>: 4K@60Hz (V_total = 2250) �?调整 V_total �?2250-4500 实现 30-60Hz VRR</p>
        </div>

        <h5>Adaptive Sync 工作流程</h5>
        <ol>
            <li><strong>Sink 上报 VRR 能力</strong>: 通过 DPCD Extended Receiver Capability 上报最�?最大刷新率</li>
            <li><strong>Source 启用 VRR</strong>: 设置 DPCD 0x1A7 �?MSA_TIMING_PAR_IGNORE_EN �?/li>
            <li><strong>动态调�?V_blanking</strong>: Source 根据 GPU 帧准备时间动态调�?V_total</li>
            <li><strong>Sink 适配显示</strong>: 显示器根据接收到�?V_total 调整刷新周期</li>
        </ol>

        <div class="example-box">
            <h5>📝 VRR 游戏场景</h5>
            <p><strong>游戏</strong>: 3A 大作，帧率波�?45-90 FPS</p>
            ...
            <ul>
                <li>45 FPS: 显示器切换到 45Hz �?无卡�?/li>
                <li>90 FPS: 显示器切换到 90Hz �?无撕裂，低延�?/li>
            </ul>
            <p><strong>效果</strong>: 流畅度提�?90%，输入延迟降�?30ms</p>
        </div>
    </div>
    ...
    <div class="concept-box">
        ...
        <div class="formula-box">
            ...
            <p><strong>8K@60Hz RGB 10-bit (无压�?</strong>:</p>
        ...
        <h5>DSC 压缩算法</h5>
        <ul>
            <li><strong>Slice 分块</strong>: 将图像分为多�?slice（如 128 行），并行压�?/li>
            <li><strong>预测编码</strong>: 使用 DPCM (Differential Pulse Code Modulation) 预测像素�?/li>
            <li><strong>量化</strong>: 根据复杂度动态调整量化参�?/li>
            <li><strong>熵编�?/strong>: 使用 Huffman 编码进一步压�?/li>
        ...
        <div class="warning-box">
            ...
            <ul>
                ...
                <li><strong>压缩伪影</strong>: 检查色块边缘、细纹理区域是否�?banding �?blockiness</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="section-block">
    ...
    <div class="warning-box">
        ...
        <h5>问题 1: Link Training 失败 (CR_DONE 未置�?</h5>
        <div class="example-box">
            <p><strong>现象</strong>: Source 无法识别显示器，热插拔无响应</p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>TX 输出电压过低 (<400 mV)</li>
                <li>PCB 走线阻抗不匹�?(�?100Ω 差分)</li>
                <li>RX CDR 无法锁定时钟</li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>示波器测�?TX 输出: 确认 Vpp = 400-600 mV (UHBR10)</li>
                <li>TDR 测试: 验证 PCB 阻抗 = 100Ω ±10%</li>
                <li>读取 DPCD 0x202: 检�?CR_DONE 位状�?/li>
                <li>尝试降低速率: UHBR20 �?UHBR13.5 �?UHBR10</li>
            </ol>
            <p><strong>解决方案</strong>: 调整 TX driver strength �?Level 2 (800 mV)</p>
        </div>

        <h5>问题 2: 显示花屏或闪�?/h5>
        <div class="example-box">
            <p><strong>现象</strong>: 显示器显示雪花、绿屏或间歇性黑�?/p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>均衡设置不当，眼图不满足要求</li>
                <li>EMI 干扰 (�?USB 3.0、Wi-Fi 频段冲突)</li>
                <li>长线缆衰减过�?(>3m @ UHBR20)</li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>捕获眼图: 验证 Eye Height >45 mV (UHBR20)</li>
                <li>BER 测试: 确认 BER <10^-12</li>
                <li>调整 Pre-emphasis: �?Level 0 逐步提升�?Level 2</li>
        ...
        <h5>问题 3: VRR 不生�?/h5>
        <div class="example-box">
            <p><strong>现象</strong>: 游戏中仍有撕裂现象，刷新率固�?60Hz</p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>Sink 未正确上�?VRR 能力 (DPCD Extended Capability 未设�?</li>
                <li>Source 未启�?MSA_TIMING_PAR_IGNORE_EN</li>
                <li>游戏引擎未使用可变帧率输�?/li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>读取 DPCD 0x2207: 验证 ADAPTIVE_SYNC_CAP �?/li>
    ...
    // ==================== HDMI 深度测试与调�?====================
    hdmiTestingDeepDive: {
        title: 'HDMI 深度测试技�?(HDMI 2.1a FRL)',
        icon: 'fa-tv',
        content: `
            <div class="deep-dive-container">
                <h2><i class="fas fa-tv"></i> HDMI 深度测试技�?/h2>

                <div class="section-block">
                    <h3>1. HDMI 2.1a FRL 固定速率链路详解</h3>

                    <div class="intro-box">
                        <h4>📺 HDMI 2.1a 革命性升�?/h4>
                        <p><strong>HDMI 2.1a</strong> 引入 <strong>FRL (Fixed Rate Link)</strong> 取代传统 TMDS，支持最�?<strong>48 Gbps</strong> 带宽，可驱动 10K@60Hz �?4K@120Hz HDR，并新增 VRR、ALLM、QMS 等游戏优化特性�?/p>
                    </div>
                    ...
                    <div class="concept-box">
                        ...
                        <div class="formula-box">
                            ...
                            <p>可传�?<strong>4K@120Hz RGB 12-bit</strong> (~39 Gbps) �?/p>
                        </div>
                    </div>
                    ...
                    <div class="concept-box">
                        ...
                        <div class="example-box">
                            <ol>
                                <li><strong>LTS:L (Link Training Start)</strong>: Source 发送训�?pattern</li>
                                <li><strong>LTS:1</strong>: Sink CDR 锁定，反�?FFE 系数请求</li>
                                <li><strong>LTS:2</strong>: Source 调整 TX 均衡，Sink 测量眼图</li>
                                <li><strong>LTS:3</strong>: 迭代优化，直到眼图满足要�?/li>
                                <li><strong>LTS:P (Pass)</strong>: 训练完成，开始传输视�?/li>
                            </ol>
                            <p><strong>训练时间</strong>: 通常 50-200 ms (取决于迭代次�?</p>
                        </div>
...
[Source HPD 检测] �?[读取 Sink EDID/SCDC]
       ...
       �?[正常视频传输] - Super Blocks (SB) with FEC
                    ...
                    <div class="warning-box">
                        ...
                        <h5>FEC 验证</h5>
                        <ul>
                            <li><strong>FEC Corrected Blocks</strong>: 读取 SCDC 0x50-0x52 寄存�?/li>
                            <li><strong>Uncorrectable Blocks</strong>: 应为 0（否则画面会花屏�?/li>
                            <li><strong>FEC 纠错�?/strong>: 正常 &lt; 0.01% (偶尔纠错可接�?</li>
                        </ul>
                    </div>
                </div>

                <div class="section-block">
                    <h3>2. HDMI 2.1a 游戏特�? VRR / ALLM / QMS</h3>

                    <div class="intro-box">
                        <h4>🎮 HDMI 2.1a 游戏优化</h4>
                        <p>HDMI 2.1/2.1a 针对游戏场景新增三大特性：<strong>VRR (可变刷新�?</strong>�?strong>ALLM (自动低延迟模�?</strong>�?strong>QMS (快速媒体切�?</strong>，显著改善游戏体验�?/p>
                    </div>

                    <h4>2.1 VRR (Variable Refresh Rate)</h4>
                    <div class="concept-box">
                        <h5>VRR 原理</h5>
                        <p>传统固定刷新�?(60Hz) 下，GPU 渲染时间不固定会导致 <strong>画面撕裂 (Tearing)</strong> �?<strong>卡顿 (Stuttering)</strong>。VRR 允许显示器刷新率动态匹�?GPU 输出帧率，消除这些问题�?/p>
                        ...
                        <h5>VRR 支持范围</h5>
                        <p>HDMI 2.1 VRR 支持 <strong>40-120 Hz</strong> 动态范围（部分显示器可�?20-240 Hz�?/p>

                        <div class="formula-box">
                            <p><strong>VRR 延迟改善</strong>:</p>
                            <p>固定 60Hz 最大延�? $\\frac{1}{60} = 16.67 ms$</p>
                            <p>VRR 120Hz 最大延�? $\\frac{1}{120} = 8.33 ms$</p>
                    ...
                    <div class="concept-box">
                        <h5>ALLM 工作原理</h5>
                        <p>�?Source (游戏主机/PC) 检测到进入游戏场景时，自动通过 InfoFrame 通知 TV 切换�?<strong>Game Mode</strong>（禁用图像处理，降低延迟）。退出游戏后自动切回电影模式�?/p>

                        <div class="example-box">
                            <h5>ALLM 切换流程</h5>
                            <ol>
                                <li><strong>游戏启动</strong>: Xbox/PS5 检测到游戏应用运行</li>
                                <li><strong>发�?ALLM InfoFrame</strong>: HDMI Source 设置 ALLM_Mode=1</li>
                                <li><strong>TV 响应</strong>: 自动切换�?Game Mode (禁用运动插帧、降噪等)</li>
                                <li><strong>延迟降低</strong>: �?~100ms (电影模式) 降至 ~10ms (游戏模式)</li>
                                <li><strong>游戏退�?/strong>: ALLM_Mode=0，TV 恢复电影模式</li>
                            </ol>
                        </div>

                        <h5>ALLM vs 手动 Game Mode</h5>
                        <ul>
                            <li><strong>自动切换</strong>: 无需用户手动调整遥控�?/li>
                            <li><strong>场景感知</strong>: 游戏/电影自动识别</li>
                            <li><strong>体验提升</strong>: 游戏低延�?+ 电影高画�?(两不�?</li>
                        </ul>
                    </div>
                    ...
                    <div class="concept-box">
                        <h5>QMS 解决的问�?/h5>
                        <p>传统 HDMI 切换分辨�?帧率时，TV 需要重�?Link Training，导�?<strong>2-3 秒黑�?/strong>。QMS 通过预协商消除黑屏�?/p>
                        ...
                        <p>结合 VRR，支�?<strong>任意帧率无缝切换</strong>�?4/30/60/120 fps�?/p>
                    </div>
                    ...
                    <div class="warning-box">
                        ...
                        <ul>
                            <li><strong>VRR 测试</strong>:
                                <ul>
                                    <li>使用 VRR Test Pattern (帧率阶跃 30�?0�?20 fps)</li>
                                    <li>高速摄像机录制 (240 fps)，检查无撕裂/卡顿</li>
                                    <li>读取 SCDC 0x30 寄存器确�?VRR Enable</li>
                                </ul>
                            </li>
                            ...
                            <li><strong>QMS 测试</strong>:
                                <ul>
                                    <li>切换 24Hz �?60Hz，测量黑屏时�?(�?&lt; 200ms)</li>
                ...
                <div class="summary-box">
                    <h3>�?HDMI 内容总结</h3>
                    <ul>
                        <li>�?<strong>HDMI 2.1a FRL</strong>: 48 Gbps�?6b/18b 编码、RS FEC 纠错</li>
                        <li>�?<strong>FRL Link Training</strong>: LTS:L �?LTS:P 五阶段训�?/li>
                        <li>�?<strong>VRR</strong>: 40-120 Hz 可变刷新率，消除撕裂/卡顿</li>
                        <li>�?<strong>ALLM</strong>: 自动游戏模式，延迟从 100ms 降至 10ms</li>
                        <li>�?<strong>QMS</strong>: 快速媒体切换，无黑屏体�?/li>
                    </ul>
                </div>

<div class="section-block">
    <h3>2. HDMI 2.1a DSC 与音频技�?/h3>

    <div class="intro-box">
        <h4>🎵 HDMI 2.1a 音视频深度整�?/h4>
        <p>HDMI 2.1a 在视�?FRL 基础上，新增 <strong>eARC (Enhanced Audio Return Channel)</strong> 支持无损音频回传，并整合 <strong>DSC 压缩</strong> 以支持超高分辨率�?/p>
    </div>

    <h4>2.1 HDMI DSC 实现详解</h4>
    <div class="concept-box">
        <p>HDMI 2.1 采用�?DP 相同�?<strong>VESA DSC 1.2a</strong>，但传输方式有所不同�?/p>
        ...
        <div class="formula-box">
            ...
            <p><strong>10K@60Hz RGB 10-bit (无压�?</strong>:</p>
        ...
        <h5>HDMI DSC 启用流程</h5>
        <ol>
            <li><strong>Source 读取 EDID</strong>: 检�?Sink 是否支持 DSC (Block 7 Extension)</li>
            <li><strong>协商压缩参数</strong>: 通过 SCDC 协商 DSC 版本、压缩比、Slice 参数</li>
            <li><strong>Source 启用压缩</strong>: �?FRL 训练完成后，使能 DSC encoder</li>
            <li><strong>Sink 解压显示</strong>: 实时解压 DSC 流，延迟 <1 �?/li>
        </ol>

        <div class="example-box">
            <h5>📝 HDMI DSC 实测</h5>
            <p><strong>测试</strong>: 8K@60Hz RGB 10-bit 输出</p>
            <p><strong>�?DSC</strong>: 需�?59.72 Gbps，超�?FRL 6 能力 �?/p>
            <p><strong>DSC 3:1</strong>:</p>
            <ul>
                <li>压缩后带�? 19.91 Gbps �?/li>
                <li>图像质量: PSNR = 43.2 dB（视觉无损）</li>
                <li>压缩延迟: 0.4 �?(14.8 μs @ 60Hz)</li>
            </ul>
    ...
    <div class="concept-box">
        ...
        <table class="reference-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>�?92 kHz (2ch)</td>
                    <td><strong>�?92 kHz (8ch)</strong></td>
                    <td>多声�?/td>
                </tr>
                <tr>
                    <td><strong>物理�?/strong></td>
                    <td>CEC 单线</td>
                    <td><strong>独立差分�?(HEAC+/HEAC-)</strong></td>
                    <td>可靠性↑</td>
                </tr>
                <tr>
                    <td><strong>延迟</strong></td>
        ...
        <ul>
            ...
            <li><strong>速率</strong>: 最�?37.8 Mbps</li>
        ...
        <div class="formula-box">
            ...
            <p>需�?<strong>MLP 无损压缩</strong> (1.5:1) �?36.9 Mbps �?/p>
        </div>

        <h5>eARC Discovery �?Capability 交换</h5>
        <ol>
            <li><strong>HPD 检�?/strong>: Sink (TV) HPD 拉高，Source (AVR) 发起连接</li>
            <li><strong>eARC Capability 读取</strong>: Source 读取 Sink EDID，确�?eARC 支持</li>
            <li><strong>Common Mode 握手</strong>: Source 发�?eARC STAT（状态查询），Sink 回复 CAP（能力）</li>
        ...
        <div class="example-box">
            <h5>📝 eARC 典型应用</h5>
            <p><strong>场景</strong>: 游戏�?(PS5) �?TV �?Soundbar</p>
            ...
            <p><strong>效果</strong>: 音频保真度提�?90%，支持全景声 Atmos</p>
        </div>
    </div>
</div>

<div class="section-block">
    <h3>3. HDMI 2.1a 游戏特性深度解�?/h3>
    ...
    <h4>3.1 VRR (Variable Refresh Rate) 可变刷新�?/h4>
    <div class="concept-box">
        <h5>VRR 工作原理</h5>
        <p>HDMI VRR 通过动态调�?<strong>V_blank 时间</strong>，实�?Source 帧率�?Sink 刷新率的实时匹配�?/p>

        <div class="formula-box">
            <p><strong>VRR 刷新率计�?/strong>:</p>
        ...
        <div class="example-box">
            <h5>📝 VRR 实测效果</h5>
            <p><strong>测试游戏</strong>: 《赛博朋�?2077》，帧率波动 45-85 FPS</p>
            <p><strong>固定 60Hz 显示</strong>:</p>
            <ul>
                <li>45 FPS 场景: 画面卡顿明显（帧重复 25%�?/li>
                <li>85 FPS 场景: V-Sync 关闭 �?撕裂；V-Sync 开�?�?输入延迟 +33ms</li>
            </ul>
            <p><strong>VRR 40-120Hz 显示</strong>:</p>
            <ul>
                <li>45 FPS 场景: 刷新率动态调整至 45Hz �?无卡�?/li>
                <li>85 FPS 场景: 刷新率动态调整至 85Hz �?无撕裂，低延�?/li>
            </ul>
            <p><strong>效果</strong>: 流畅度提�?92%，输入延迟降�?27ms</p>
        </div>
    </div>

    <h4>3.2 ALLM (Auto Low Latency Mode) 自动低延迟模�?/h4>
    <div class="concept-box">
        <h5>ALLM 原理</h5>
        <p>ALLM 允许 Source 自动通知 Sink 切换�?<strong>Game Mode (游戏模式)</strong>，关闭图像后处理（如运动补偿、锐化、降噪），降低显示延迟�?/p>

        <h5>ALLM 触发流程</h5>
        <ol>
            <li><strong>Source 检测游戏内�?/strong>: 游戏主机（PS5/Xbox）检测到游戏应用启动</li>
            <li><strong>发�?InfoFrame</strong>: Source 通过 SPD (Source Product Descriptor) InfoFrame 通知 Sink</li>
            <li><strong>Sink 自动切换</strong>: TV 自动切换�?Game Mode，关闭图像后处理</li>
            <li><strong>用户无感�?/strong>: 无需手动调整 TV 设置</li>
        </ol>
        ...
        <div class="example-box">
            ...
            <p><strong>优势</strong>: 玩游戏时延迟降低 84% (85ms �?13ms)，切换回电影自动恢复后处�?/p>
        </div>
    </div>

    <h4>3.3 QMS (Quick Media Switching) 快速媒体切�?/h4>
    <div class="concept-box">
        <h5>QMS 解决的问�?/h5>
        <p>传统 HDMI 在切换分辨率/刷新率时，会出现 <strong>黑屏 2-3 �?/strong>（Link Training 时间）。QMS 通过预协商参数，实现 <strong>无黑屏切�?/strong>�?/p>

        <h5>QMS 工作机制</h5>
        <ul>
            <li><strong>QMS-VRR</strong>: �?VRR 范围内切换刷新率，无需重新 Link Training</li>
        ...
        <div class="example-box">
            <h5>📝 QMS 实测</h5>
            <p><strong>场景</strong>: 观看 Netflix，内容从 24fps 电影切换�?60fps 纪录�?/p>
...
<div class="section-block">
    ...
    <div class="warning-box">
        ...
        <h5>问题 1: FRL Training 失败 (降级�?TMDS 模式)</h5>
        <div class="example-box">
            <p><strong>现象</strong>: HDMI 2.1 设备连接后仅工作�?HDMI 2.0 (18 Gbps) 模式</p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>线缆不支�?FRL (�?Ultra High Speed 认证)</li>
                <li>FRL Link Training LTS:3 阶段眼图不满足要�?/li>
            ...
            <ol>
                ...
                <li>更换线缆: 使用 HDMI 2.1 Ultra High Speed 48Gbps 认证�?/li>
            </ol>
            <p><strong>解决方案</strong>: 更换线缆 + 调整 TX FFE �?6 dB</p>
        </div>

        <h5>问题 2: eARC 无音频输�?/h5>
        <div class="example-box">
            <p><strong>现象</strong>: TV 音频回传�?AVR 失败，Soundbar 无声�?/p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>TV 未启�?eARC (设置�?ARC 选项关闭)</li>
                <li>HEAC+/- 差分对连接不�?(Pin 14/18)</li>
                <li>CEC 命令 <SET_AUDIO_RETURN_CHANNEL> 未发�?/li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>检�?TV 设置: 启用 HDMI Control (CEC) �?eARC</li>
                <li>示波器测�?HEAC+/-: 验证差分电压 ~250 mV</li>
                <li>CEC 抓包: 确认 Sink 发�?<SET_AUDIO_RETURN_CHANNEL></li>
                <li>读取 EDID Block 7: 确认 eARC 能力�?/li>
            </ol>
            <p><strong>解决方案</strong>: 更新 TV 固件，启�?eARC 功能</p>
        </div>

        <h5>问题 3: VRR 显示撕裂或卡�?/h5>
        <div class="example-box">
            <p><strong>现象</strong>: 游戏中启�?VRR 后仍有撕裂，或低帧率时画面卡�?/p>
            <p><strong>可能原因</strong>:</p>
            <ul>
                <li>TV VRR 范围过窄 (�?60-120Hz，游戏跑 45 FPS 时无法匹�?</li>
                <li>游戏引擎未启�?VRR 输出 (固定 60 fps 输出)</li>
                <li>HDMI Forum VRR �?AMD FreeSync / NVIDIA G-Sync 兼容性问�?/li>
            </ul>
            <p><strong>调试步骤</strong>:</p>
            <ol>
                <li>读取 EDID Timing Extension: 检�?VRR Min/Max �?/li>
                <li>游戏设置: 关闭 V-Sync，启�?VRR 输出</li>
...
<div class="summary-box">
    ...
    <ul>
        <li>�?<strong>DP UHBR PHY �?/strong>: 10/13.5/20 Gbps 物理特性、TX/RX 均衡详解</li>
        <li>�?<strong>DP Adaptive Sync</strong>: VRR 原理�?0-144Hz 动态刷新、游戏场�?/li>
        <li>�?<strong>DP DSC 1.2a</strong>: 3:1 压缩算法、PSNR 质量验证�?6K@60Hz 支持</li>
        <li>�?<strong>DP 调试案例</strong>: Link Training 失败、花屏闪烁、VRR 不生�?/li>
        <li>�?<strong>HDMI DSC</strong>: FRL Super Block 封装�?0K@60Hz 支持</li>
        <li>�?<strong>HDMI eARC</strong>: 37 Mbps 带宽、TrueHD/Atmos 无损回传、HEAC+/- 物理�?/li>
        <li>�?<strong>HDMI VRR/ALLM/QMS</strong>: 游戏优化三大特性、延迟降�?90%、无黑屏切换</li>
